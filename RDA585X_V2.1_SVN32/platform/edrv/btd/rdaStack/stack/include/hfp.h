...
APIDECL1 t_api APIDECL2 HF_Get_Char_Code(void);
APIDECL1 t_api APIDECL2 HF_Get_PhoneBook_Size(void);
APIDECL1 t_api APIDECL2 HF_Q_Char_Code(void);
APIDECL1 t_api APIDECL2 HF_Set_PhoneBook_Code(char *code);
