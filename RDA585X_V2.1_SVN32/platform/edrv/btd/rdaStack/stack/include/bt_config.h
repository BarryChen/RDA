/*
 * MODULE NAME:    bt_config.h
 * DESCRIPTION:    Bluestream Configurate Structure define header
 * AUTHOR:         Tianwq
 *
 * SOURCE CONTROL: $Id: bt_config.h,v 1.2 2007/12/19 07:49:16 tianwq Exp $
 *
 * LICENSE:
 *     This source code is copyright (c) 2000-2012 RDA Microelectronics.
 *     All rights reserved.
 *
 */
