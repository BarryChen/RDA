 ...
 *
 * SOURCE CONTROL: $Id: obex_defines.h,v 1.1.1.1 2007/12/18 05:32:40 tianwq Exp $
 *
 * LICENSE:
...
APIDECL1 int APIDECL2 OBEX_RegisterService(u_int8* rx_buffer, u_int16 buff_length, u_int16 uuid);
...
APIDECL1 int APIDECL2 OBEX_TransportConnect_RF(t_bdaddr address,u_int8 server_channel, u_int32* tid, u_int16 mtu);//,void (*callbackFunc)(u_int32 tid));
...
APIDECL1 t_api APIDECL2 OBEX_GetMsg(u_int32 tid, u_int32 cid,enum Msg_Type type, u_int32 index);
