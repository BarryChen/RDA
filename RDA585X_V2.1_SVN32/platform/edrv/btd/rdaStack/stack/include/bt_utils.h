/*
 * MODULE NAME:    host_utils.h
 * DESCRIPTION:    utililies function for common usage
 * AUTHOR:         Tianwq
 * DATE:           10 Nov 2010
 *
 ...
 *
 * LICENSE:
 *     This source code is copyright (c) 2010-2012 RDA Microelectronics.
 *     All rights reserved.
 *
 */
...
#define RDABT_Check_Anonymity_Mode(features)            ( features[4] & ANONYMITY_MODE_MASK )
