/*************************************************************************
 *
 * MODULE NAME:    rda5876p_init.c
 * PROJECT CODE:   rdabt
 * DESCRIPTION:    rda5876p initiation.
 * MAINTAINER:     mql
 * CREATION DATE:  05/06/12
 *
 * SOURCE CONTROL: $Id: rda5870_init.c,v3.20 2012/06/04 15:50:38 mql Exp $
 *
 * LICENSE:
...
{
	{0x40180004,0x0001b578},//prepare trx									
	{0x40180024,0x0001dc68},												
	{0x40180008,0x00003034},	//uart											
	{0x40180028,0x00000014},	 
	{0x4018000c,0x0001514c}, //sco alloc
