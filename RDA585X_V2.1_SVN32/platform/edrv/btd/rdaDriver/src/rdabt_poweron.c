 ...
 *
 * SOURCE CONTROL: $Id: rdabt_poweron.c 16308 2012-07-13 05:54:10Z admin $
 *
 * LICENSE:
...
unsigned char rdabt_chip_sel = RDA_BT_R18_8809E_ENUM;//default for 8809e
...
void rdabt_common_baudrate_flow_ctrl(void)
{
    ...
    rdabt_adp_uart_configure(BT_UART_BAUDRATE/*460800*//*230400*/,FALSE);
    ...
    sxr_Sleep(200 MS_WAITING);
    rdabt_adp_uart_configure(BT_UART_BAUDRATE/*921600*//*460800*//*230400*/,TRUE);
}
