 ...
 *
 * SOURCE CONTROL: $Id: rdabt_test.c 15851 2012-06-08 12:42:31Z yanshengzhang $
 *
 * LICENSE:
...
void Rdabt_test_write_r12()
{
    uint16 i;
   for(i=0;i<sizeof(rdabt_test_12)/sizeof(rdabt_test_12[0]);i++)
   {
      rdabt_wirte_memory(rdabt_test_12[i][0],&rdabt_test_12[i][1],1,0x0);
      RDABT_DELAY(1);
   }
}
	...
	case RDA_BT_R10_AL_5872H_ENUM:
      ...
      case RDA_BT_R12_5876_ENUM:
  	 ...
  	 //   RDABT_DELAY(5); //wait for digi running
  	    ...
  	    rdabt_DC_write_r12(); 
           Rdabt_test_pskey_write_r11(); 
           Rdabt_test_write_r12(); // add patch
           hal_HstSendEvent(SYS_EVENT, 0x13121701);
	    break;
#endif
...
#else
#if 0
    static HAL_SYS_CLOCK_OUT_ID_T g_RdaBtClockOutId;
...
//{
//uint32 t_syncword_low; //syncword
//uint32 t_syncword_hight;
//uint16 t_tx_len; //packet length
//uint8 hop_enable; //1:enable 0:disable
//uint8 t_hop_frq; /* val: [0.....78]*/
//uint8 t_msg_type; //0...3
//uint8 t_tx_packet_type;//packet type
//uint8 t_EDR_mode; // 1,2,3
//uint8 t_power_level; //power level
//uint8 crc_init;
//uint8 is_whiten; 
//uint8 whiten_init;
//uint8 t_am_addr; /* 3 bits*/
//} t_bt_test_burst;
