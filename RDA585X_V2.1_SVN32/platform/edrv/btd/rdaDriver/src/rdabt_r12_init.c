 ...
 *
 * SOURCE CONTROL: $Id: rdabt_r11_init.c,v3.23 2010/11/05 15:50:38 mql Exp $
 *
 * LICENSE:
...
#if 0  // 2012 11 23 for pta para update
...
#else
 {0x4020004c,0x03500ffff},   
 {0x40200050,0x02eb20000},   
 {0x40200054,0x0ffffffff},  
 {0x40200058,0x002D00221},
#endif
...
{ 0x40200000, 0x78000aaf },
{ 0x40200004, 0x0002037c },
