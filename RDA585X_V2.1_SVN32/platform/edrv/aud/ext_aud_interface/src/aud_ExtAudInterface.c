...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Sources/edrv/trunk/aud/codec_gallite/src/aud_codec_gallite.c $ //
//	$Author: huazeng $                                                        // 
//	$Date: 2010-08-16 15:46:42 +0800 (星期一, 16 八月 2010) $                     //   
//	$Revision: 1328 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
PUBLIC AUD_ERR_T aud_ExtAudInterfaceSetup(SND_ITF_T itf, CONST AUD_DEVICE_CFG_T* cfg)
{
    ...
    calibOutGains.calibValue = calibPtr->bb->audio[calibPtr->aud.gainItfMap[itf]].audioGains.outGain[cfg->level->spkLevel];
          ...
          cfg->micSel == AUD_MIC_LOUD_SPEAKER )
    {
        ...
        if (cfg->level->micLevel != SND_MIC_MUTE)
        {
            ...
            micCfg.micGain = calibPtr->bb->audio[calibPtr->aud.gainItfMap[itf]].audioGains.inGain;
        }
    ...
    {
        hal_AifSetSideTone(calibPtr->bb->audio[calibPtr->aud.gainItfMap[itf]].audioGains.sideTone[cfg->level->spkLevel]);
    }
