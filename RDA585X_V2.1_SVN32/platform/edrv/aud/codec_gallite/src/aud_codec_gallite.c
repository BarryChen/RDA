...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/edrv/aud/codec_gallite/src/aud_codec_gallite.c $ //
//	$Author: huazeng $                                                        // 
//	$Date: 2011-12-14 10:43:29 +0800 (星期三, 14 十二月 2011) $                     //   
//	$Revision: 12602 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
PRIVATE VOID aud_CodecGalliteI2SAifCfg(CONST HAL_AIF_STREAM_T* stream)
{
    ...
    if((1 == stream->voiceQuality)&&(1 == stream->channelNb))
    {
        ...
        I2SAifConfig.enableBckOutGating=FALSE;
