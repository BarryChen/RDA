...
// MEMD config etron
// =============================================================================
#ifndef TGT_MEMD_CONFIG_ETRON
#define TGT_MEMD_CONFIG_ETRON
...
#define SRAM_TIME_SETTING_8809_ETRON {                                  \
    .rdLatHalfMode  = 1,                                                \
    .rdLat          = 3,                                                \
    .oedlyHalfMode  = 0,                                                \
    .oedly          = 0,                                                \
    ...
    .relax          = 1,                                                \
    .forceRelax     = 0}
#define SRAM_MODE_SETTING_8809_ETRON {                                  \
    .csEn           = 1,                                                \
    .polarity       = 0,                                                \
    .admuxMode      = 1,                                                \
    .writeAllow     = 1,                                                \
...
#define TGT_RAM_CONFIG_8809_ETRON                                       \
    {                                                                   \
        {SRAM_TIME_SETTING_8809_ETRON, SRAM_MODE_SETTING_8809_ETRON}    \
    }


#endif // TGT_MEMD_CONFIG_ETRON
