...
// MEMD config
// =============================================================================
#ifndef TGT_MEMD_CONFIG_WINBOND
#define TGT_MEMD_CONFIG_WINBOND
...
#define SRAM_TIME_SETTING_WINBOND {                                             \
    .rdLatHalfMode  = 1,                                                \
    .rdLat          = 3,                                                \
    .oedlyHalfMode  = 0,                                                \
    .oedly          = 2,                                                \
    ...
    .relax          = 1,                                                \
    .forceRelax     = 0}
#define SRAM_MODE_SETTING_WINBOND {                                             \
    .csEn           = 1,                                                \
    .polarity       = 0,                                                \
    .admuxMode      = 1,                                                \
    .writeAllow     = 1,                                                \
...
#define TGT_RAM_CONFIG_8808S_WINBOND                                             \
    {                                                                   \
        {SRAM_TIME_SETTING_WINBOND, SRAM_MODE_SETTING_WINBOND}                          \
    }



#endif // TGT_MEMD_CONFIG_WINBOND
