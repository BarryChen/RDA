...
//#define MWRITE_32(addr,data)  { *((volatile UINT32 *)(addr)) = data; hal_HstSendEvent(SYS_EVENT,addr);  hal_HstSendEvent(SYS_EVENT,data);}
...
//    hal_HstSendEvent(SYS_EVENT,0x8C000000|(flash_addr&0xffffff));
    SPI_Flash_Disable_Read();
...
*/
	*(volatile unsigned int*)ADDR_SAVING_FLASHID_4_USB = FLASH_1_16MBIT;
}
