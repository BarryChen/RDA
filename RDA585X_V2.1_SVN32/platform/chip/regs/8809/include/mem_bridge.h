...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/chip/regs/8809/include/mem_bridge.h $                                                                   
//  $Author: huazeng $                                                                    
//  $Date: 2012-03-13 20:03:49 +0800 (星期二, 13 三月 2012) $                                                                      
//  $Revision: 14104 $                                                                  
//                                                                              
//==============================================================================
//
...
#define hwp_memBridge_BB               ((HWP_MEM_BRIDGE_T*) KSEG1(REG_MEM_BRIDGE_BASE_BB))
...
typedef volatile struct
{
    UINT8 ram_array[0x08000000];                  //0x00000000
} HWP_EBC_CS0_T;
...
typedef volatile struct
{
    UINT8 ram_array[0x02000000];                  //0x00000000
} HWP_EBC_CS1_T;
...
typedef volatile struct
{
    UINT8 ram_array[0x00080000];                    //0x00000000
} HWP_EBC_CS2_T;
...
typedef volatile struct
{
    UINT8 ram_array[0x00040000];                    //0x00000000
} HWP_EBC_CS3_T;
...
typedef volatile struct
{
    UINT8 ram_array[0x00800000];                   //0x00000000
} HWP_EBC_CS4_T;
...
typedef volatile struct
{
    UINT8 sram_array[0x00010000];                    //0x00000000
} HWP_INT_SRAM_T;
...
typedef volatile struct
{
    UINT8 rom_array[0x00005000];                     //0x00000000
} HWP_INT_ROM_T;
...
typedef volatile struct
{
    UINT8 rom_array[0x00018000];                     //0x00000000
} HWP_BCPU_ROM_T;

#define hwp_bcpuRom                  ((HWP_INT_ROM_T*) KSEG1(REG_BCPU_ROM_BASE))
