...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/chip/regs/8809/include/sys_ctrl.h $                                                                   
//  $Author: pengzg $                                                                    
//  $Date: 2012-05-25 17:19:43 +0800 (星期五, 25 五月 2012) $                                                                      
//  $Revision: 15424 $                                                                  
//                                                                              
//==============================================================================
//
...
/// System side resets
    ...
    RST_BB_FULL                                 = 0x00000035,
    RST_SYS_FULL                                = 0x00000036
} RESETS_T;

#define NB_SRST                                  (36)
/// Baseband side resets
#define BOUND_BRST_FIRST                         (36)
#define BOUND_BRST_AFTER                         (53)
/// The following reset does not have register
#define NR_RST_REG                               (54)
#define NB_RST                                   (55)
...
#define SYS_CTRL_SET_BB_RST(n)      (((n)&0x7FFFFF)<<0)
#define SYS_CTRL_SET_BB_RST_MASK    (0x7FFFFF<<0)
...
#define SYS_CTRL_CLR_BB_RST(n)      (((n)&0x7FFFFF)<<0)
#define SYS_CTRL_CLR_BB_RST_MASK    (0x7FFFFF<<0)
...
#define SYS_CTRL_MODE_CLK_BB(n)     (((n)&0x1FFFFF)<<1)
#define SYS_CTRL_MODE_CLK_BB_MASK   (0x1FFFFF<<1)
...
#define SYS_CTRL_ENABLE_BB_IRQ      (1<<22)
#define SYS_CTRL_ENABLE_CLK_BB(n)   (((n)&0x7FFFFF)<<0)
#define SYS_CTRL_ENABLE_CLK_BB_MASK (0x7FFFFF<<0)
...
#define SYS_CTRL_DISABLE_BB_IRQ     (1<<22)
#define SYS_CTRL_DISABLE_CLK_BB(n)  (((n)&0x7FFFFF)<<0)
#define SYS_CTRL_DISABLE_CLK_BB_MASK (0x7FFFFF<<0)
...
#define SYS_CTRL_BB_PLL_ENABLE         (1<<16)
#define SYS_CTRL_BB_PLL_ENABLE_MASK    (1<<16)
#define SYS_CTRL_BB_PLL_ENABLE_SHIFT   (16)
#define SYS_CTRL_BB_PLL_ENABLE_POWER_DOWN (0<<16)
#define SYS_CTRL_BB_PLL_ENABLE_ENABLE  (1<<16)
#define SYS_CTRL_BB_PLL_LOCK_RESET     (1<<20)
#define SYS_CTRL_BB_PLL_LOCK_RESET_MASK (1<<20)
#define SYS_CTRL_BB_PLL_LOCK_RESET_SHIFT (20)
#define SYS_CTRL_BB_PLL_LOCK_RESET_RESET (0<<20)
#define SYS_CTRL_BB_PLL_LOCK_RESET_NO_RESET (1<<20)
#define SYS_CTRL_BB_PLL_BYPASS         (1<<24)
#define SYS_CTRL_BB_PLL_BYPASS_MASK    (1<<24)
#define SYS_CTRL_BB_PLL_BYPASS_SHIFT   (24)
#define SYS_CTRL_BB_PLL_BYPASS_PASS    (0<<24)
#define SYS_CTRL_BB_PLL_BYPASS_BYPASS  (1<<24)
#define SYS_CTRL_BB_PLL_CLK_FAST_ENABLE (1<<28)
#define SYS_CTRL_BB_PLL_CLK_FAST_ENABLE_MASK (1<<28)
#define SYS_CTRL_BB_PLL_CLK_FAST_ENABLE_SHIFT (28)
#define SYS_CTRL_BB_PLL_CLK_FAST_ENABLE_ENABLE (1<<28)
#define SYS_CTRL_BB_PLL_CLK_FAST_ENABLE_DISABLE (0<<28)
...
#define SYS_CTRL_SYS_SEL_TCU_26M    (1<<5)
#define SYS_CTRL_SYS_SEL_TCU_13M    (0<<5)
#define SYS_CTRL_SYS_PLL_DISABLE_LPS (1<<6)
#define SYS_CTRL_SYS_PLL_ENABLE_LPS (0<<6)
#define SYS_CTRL_DIGEN_H_ENABLE     (1<<7)
#define SYS_CTRL_DIGEN_H_DISABLE    (0<<7)
#define SYS_CTRL_BB_SEL_FAST_SLOW   (1<<10)
#define SYS_CTRL_BB_SEL_FAST_FAST   (0<<10)
#define SYS_CTRL_BB_PLL_LOCKED      (1<<11)
#define SYS_CTRL_BB_PLL_LOCKED_MASK (1<<11)
#define SYS_CTRL_BB_PLL_LOCKED_SHIFT (11)
#define SYS_CTRL_BB_PLL_LOCKED_LOCKED (1<<11)
#define SYS_CTRL_BB_PLL_LOCKED_NOT_LOCKED (0<<11)
#define SYS_CTRL_BB_PLL_BYPASS_LOCK (1<<12)
#define SYS_CTRL_BB_FAST_SELECTED_L (1<<13)
#define SYS_CTRL_BB_FAST_SELECTED_L_MASK (1<<13)
#define SYS_CTRL_BB_FAST_SELECTED_L_SHIFT (13)
...
#define SYS_CTRL_BB_SYS_SAME_ENABLE (1<<28)
#define SYS_CTRL_BB_SYS_SAME_DISABLE (0<<28)
#define SYS_CTRL_TCU_SYS_SAME_ENABLE (1<<29)
#define SYS_CTRL_TCU_SYS_SAME_DISABLE (0<<29)
#define SYS_CTRL_MPMC_SYS_SAME_ENABLE (1<<30)
#define SYS_CTRL_MPMC_SYS_SAME_DISABLE (0<<30)
#define SYS_CTRL_FAST_SELECTED_L    (1<<31)
#define SYS_CTRL_FAST_SELECTED_L_MASK (1<<31)
#define SYS_CTRL_FAST_SELECTED_L_SHIFT (31)

//Cfg_Clk_Sys
#define SYS_CTRL_FREQ(n)            (((n)&0xF)<<0)
#define SYS_CTRL_FREQ_MASK          (0xF<<0)
...
//Cfg_Clk_Mem_Bridge
#define SYS_CTRL_MEM_FREQ(n)        (((n)&0xF)<<0)
#define SYS_CTRL_MEM_FREQ_MASK      (0xF<<0)
...
#define SYS_CTRL_MEM_DDR_DISABLE    (1<<6)
#define SYS_CTRL_MEM_DDR_ENABLE     (0<<6)
#define SYS_CTRL_MEM_DDR_DQSL_I(n)  (((n)&3)<<8)
#define SYS_CTRL_MEM_DDR_DQSU_I(n)  (((n)&3)<<10)
#define SYS_CTRL_MEM_DDR_DQSL_O(n)  (((n)&3)<<12)
#define SYS_CTRL_MEM_DDR_DQSU_O(n)  (((n)&3)<<14)
#define SYS_CTRL_MEM_DDR_PLL_OFF    (1<<16)

//Cfg_Clk_Voc
#define SYS_CTRL_VOC_FREQ(n)        (((n)&0xF)<<0)
#define SYS_CTRL_VOC_FREQ_MASK      (0xF<<0)
...
//Cfg_Clk_BB
#define SYS_CTRL_BB_FREQ(n)         (((n)&7)<<0)
#define SYS_CTRL_BB_FREQ_MASK       (7<<0)
...
#define SYS_CTRL_BB_FREQ_104M       (4<<0)
#define SYS_CTRL_BB_FREQ_156M       (5<<0)
#define SYS_CTRL_BB_FREQ_208M       (6<<0)
#define SYS_CTRL_BB_FREQ_312M       (7<<0)
#define SYS_CTRL_BB_FORCE_DIV_UPDATE (1<<4)
#define SYS_CTRL_BB_REQ_DIV_UPDATE  (1<<8)
...
#define SYS_CTRL_CLK_SPI_CAMERA_DIV_MASK    (0x7ff<<16)
#define SYS_CTRL_CLK_SPI_CAMERA_DIV_SHIFT   (16)
#define SYS_CTRL_CLK_SPI_CAMERA_POL_NORMAL  (0<<27)
#define SYS_CTRL_CLK_SPI_CAMERA_POL_INV     (1<<27)
...
#define SYS_CTRL_ENABLE_SEL_GOUDA_AHB (1<<15)
#define SYS_CTRL_ENABLE_SEL_GOUDA_MEM_BRIDGE (0<<15)
...
#define SYS_CTRL_SPIFLASH_FREQ_MASK (0xF<<0)
...
//Cfg_Clk_MPMC
#define SYS_CTRL_MPMC_FREQ(n)       (((n)&0xF)<<0)
#define SYS_CTRL_MPMC_FREQ_MASK     (0xF<<0)
...
#define SYS_CTRL_MPMC_DELAY(n)      (((n)&0xF)<<4)
#define SYS_CTRL_MPMC_DELAY_MASK    (0xF<<4)
#define SYS_CTRL_MPMC_DELAY_SHIFT   (4)
#define SYS_CTRL_MPMC_DELAY_POL_INV (1<<8)
#define SYS_CTRL_MPMC_DELAY_POL     (0<<8)
#define SYS_CTRL_MPMC_FEEDBACK(n)   (((n)&0xF)<<12)
#define SYS_CTRL_MPMC_FEEDBACK_MASK (0xF<<12)
#define SYS_CTRL_MPMC_FEEDBACK_SHIFT (12)
#define SYS_CTRL_MPMC_FEEDBACK_POL_INV (1<<16)
#define SYS_CTRL_MPMC_FEEDBACK_POL  (0<<16)
...
#define SYS_CTRL_ENABLE_CLK_SYS2(n) (((n)&0xF)<<0)
#define SYS_CTRL_ENABLE_CLK_SYS2_MASK (0xF<<0)
...
#define SYS_CTRL_DISABLE_CLK_SYS2(n) (((n)&0xF)<<0)
#define SYS_CTRL_DISABLE_CLK_SYS2_MASK (0xF<<0)
#define SYS_CTRL_DISABLE_CLK_SYS2_SHIFT (0)

//Cfg_Reserved
#define SYS_CTRL_UART1_TCO          (1<<0)
