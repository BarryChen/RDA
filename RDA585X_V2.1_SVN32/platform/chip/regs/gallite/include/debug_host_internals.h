...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.coolsand-tech.com/svn/developing1/Sources/chip/branches/gallite441/regs/gallite/include/debug_host_internals.h $                                                                   
//  $Author: admin $                                                                    
...
#define DEBUG_HOST_INTERNAL_REGISTERS_MASK_SPLIT_BB_MID_VOC (1<<2)
#define DEBUG_HOST_INTERNAL_REGISTERS_MASK_SPLIT_BB_MID_BCPU (1<<3)
#define DEBUG_HOST_INTERNAL_REGISTERS_MASK_SPLIT_BB_MID_AHB2AHB (1<<4)
#define DEBUG_HOST_INTERNAL_REGISTERS_MASK_SPLIT_BB_MID_IFC (1<<5)
