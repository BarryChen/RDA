...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/chip/regs/8808/include/cfg_regs.h $                                                                   
//  $Author: pengzg $                                                                    
//  $Date: 2012-06-15 11:22:24 +0800 (周五, 15 六月 2012) $                                                                      
//  $Revision: 15998 $                                                                  
//                                                                              
//==============================================================================
//
...
#define CFG_REGS_SDMMC2_MASK        (1<<11)
#define CFG_REGS_SDMMC2_SPI1        (0<<11)
#define CFG_REGS_SDMMC2_SDMMC2      (1<<11)
...
#define CFG_REGS_M_D_DRIVE_FAST_FAST (0<<0)
//#define CFG_REGS_M_D_DRIVE_FAST   (1<<0)
//#define CFG_REGS_M_D_DRIVE_SLOW   (2<<0)
//#define CFG_REGS_M_D_DRIVE_SLOW_SLOW (3<<0)
#define CFG_REGS_LCD_DATA_DRIVE_MASK (3<<2)
#define CFG_REGS_LCD_DATA_DRIVE_FAST_FAST (0<<2)
#define CFG_REGS_CAM_DRIVE_MASK     (3<<4)
#define CFG_REGS_CAM_DRIVE_FAST_FAST (0<<4)
#define CFG_REGS_GPO_DRIVE_MASK     (3<<6)
#define CFG_REGS_GPO_DRIVE_FAST_FAST (0<<6)
#define CFG_REGS_KEYPAD_DRIVE_MASK  (3<<8)
#define CFG_REGS_KEYPAD_DRIVE_FAST_FAST (0<<8)
#define CFG_REGS_SDMMC_CTRL_DRIVE_MASK (3<<10)
#define CFG_REGS_SDMMC_CTRL_DRIVE_FAST_FAST (0<<10)

//IO_Drive2_Select
#define CFG_REGS_M_SPI_D_DRIVE_MASK    (3<<0)
#define CFG_REGS_M_SPI_D_DRIVE_NORMAL  (0<<0)
#define CFG_REGS_M_SPI_D_DRIVE_INPUT   (1<<0)
#define CFG_REGS_M_SPI_D_DRIVE_OUTPUT0 (2<<0)
#define CFG_REGS_M_SPI_D_DRIVE_OUTPUT1 (3<<0)
#define CFG_REGS_SPI_CAM_LCD_DRIVE_MASK    (3<<2)
#define CFG_REGS_SPI_CAM_LCD_DRIVE_NORMAL  (0<<2)
#define CFG_REGS_SPI_CAM_LCD_DRIVE_DIRECT  (1<<2)
#define CFG_REGS_SPI_CAM_LCD_DRIVE_HIGHZ   (2<<2)
#define CFG_REGS_SPI_CAM_LCD_DRIVE_DIRECEGPIO (3<<2)
// 8808s only
#define CFG_REGS_8808S_SDMMC2_MASK         (3<<4)
#define CFG_REGS_8808S_SDMMC2_NONE         (0<<4)
#define CFG_REGS_8808S_SDMMC2_SPI1_SDMMC2  (1<<4)
#define CFG_REGS_8808S_SDMMC2_LCD_SDMMC2   (2<<4)
#define CFG_REGS_8808S_SDMMC2_KEY_SDMMC2   (3<<4)
#define CFG_REGS_KEYIN_0_GPIO_20     (1<<6)
#define CFG_REGS_KEYIN_4_GPIO_21     (1<<7)
#define CFG_REGS_KEYOUT_1_GPIO_17    (1<<8)
#define CFG_REGS_KEYOUT_2_GPIO_11    (1<<9)
#define CFG_REGS_KEYOUT_3_GPIO_7     (1<<10)
#define CFG_REGS_KEYOUT_4_GPIO_8     (1<<11)
#define CFG_REGS_UART2_SPI1_UART2    (1<<12)
