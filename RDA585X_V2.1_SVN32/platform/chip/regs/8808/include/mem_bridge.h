...
//                       !!! PLEASE DO NOT EDIT !!!                             
//                                                                              
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/chip/regs/8808/include/mem_bridge.h $                                                                   
//  $Author: huazeng $                                                                    
//  $Date: 2012-03-13 20:03:49 +0800 (周二, 13 三月 2012) $                                                                      
//  $Revision: 14104 $                                                                  
//                                                                              
//==============================================================================
//
...
typedef volatile struct
{
    UINT8 ram_array[0x01000000];                  //0x00000000
} HWP_EBC_CS1_T;
...
typedef volatile struct
{
    UINT8 rom_array[0x00014000];                     //0x00000000
} HWP_INT_ROM_T;
