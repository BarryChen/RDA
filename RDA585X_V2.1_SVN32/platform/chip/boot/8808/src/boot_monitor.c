...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/chip/boot/8808/src/boot_monitor.c $ //
//  $Author: huazeng $                                                         //
//  $Date: 2011-12-31 20:41:51 +0800 (周六, 31 十二月 2011) $                     //
//  $Revision: 12997 $                                                        //
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
//=============================================================================
// _romed_nand_flash_boot_start
//-----------------------------------------------------------------------------
/// The symbol at the start of the NAND flash boot copy
//=============================================================================
extern UINT32 _nand_flash_boot_start;


//=============================================================================
// BOOT_NAND_FLASH_ENTRY_POINT
//-----------------------------------------------------------------------------
/// First address where to jump to execute code in NAND flash boot copy
//=============================================================================
#define BOOT_NAND_FLASH_ENTRY_POINT ((UINT32)&_nand_flash_boot_start+0x10)


//=============================================================================
// BOOT_NAND_FLASH_PROGRAMMED_PATTERN_ADDRESS
//-----------------------------------------------------------------------------
/// Address of the programmed NAND flash pattern.
//=============================================================================
#define BOOT_NAND_FLASH_PROGRAMMED_PATTERN_ADDRESS ((UINT32*)&_nand_flash_boot_start)
...
PROTECTED VOID boot_Monitor(VOID)
{
    ...
    if (g_bootBootMode & BOOT_MODE_NAND_FLASH)
    {
        flashEntry = (VOID(*)(UINT32)) BOOT_NAND_FLASH_ENTRY_POINT;
    }
    else
    {
...
PROTECTED VOID boot_MonitorDoMonitoring(VOID)
{
    ...
    {
        boot_NandOpen();
        boot_NandReadPages(0, BOOT_NAND_FLASH_PROGRAMMED_PATTERN_ADDRESS, NAND_FLASH_BOOT_CODE_SIZE);
        boot_FlushCache();
        // Check if NAND flash is programmed
        if (*(BOOT_NAND_FLASH_PROGRAMMED_PATTERN_ADDRESS) == BOOT_FLASH_PROGRAMMED_PATTERN)
        {
