...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/chip/hal/src/hal_gpio.c $//
//  $Author: admin $                                                        // 
...
VOID HAL_FUNC_INTERNAL hal_GpioSet(HAL_APO_ID_T apo)
{
    ...
    SWAP_GPIO_24_AND_25(apo.gpioId);
...
PUBLIC VOID hal_GpioIrqSetHandler(HAL_GPIO_GPIO_ID_T gpio, HAL_GPIO_IRQ_HANDLER_T handler)
{
    HAL_APO_ID_T apo;
    apo.gpioId = gpio;
    if(apo.type == HAL_GPIO_TYPE_NONE || gpio > HAL_GPIO_7)
    {
        return;
    }
    HAL_ASSERT(apo.type == HAL_GPIO_TYPE_IO, gc_errWrongGpioType);
...
PUBLIC VOID hal_GpioGetCfg(HAL_GPIO_GPIO_ID_T gpio, HAL_GPIO_CFG_T* cfg)
{
    ...
    if(gpio <= HAL_GPIO_7)
    {
        ...
        cfg->irqHandler = g_halGpioRegistry[apo.id];
    }
}
