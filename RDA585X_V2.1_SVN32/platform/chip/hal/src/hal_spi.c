...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/chip/hal/src/hal_spi.c $ //
//    $Author: admin $                                                        // 
...
PRIVATE VOID hal_SpiDoConfigCs(HAL_SPI_ID_T id, CONST HAL_SPI_CFG_T* spiConfigPtr)
{
   ...
   // HAL_ASSERT((UINT32)spiConfigPtr->oeRatio <= 31,
    ...
    //HAL_TRACE(_SXR | TSTDOUT, 0, "SPI_CS0 polarity: %d",halCfg->spiCfg[id].cs0ActiveLow);
    //HAL_TRACE(_SXR | TSTDOUT, 0, "SPI_CS0 polarity after forcing:
