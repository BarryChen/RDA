...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/chip/hal/src/hal_rfspi.c $ //
//    $Author: admin $                                                        // 
//    $Date: 2012-12-07 21:09:41 +0800 (周五, 07 十二月 2012) $                     //   
//    $Revision: 18062 $                                                          //   
//                                                                            //
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
...
#else
        spiDivider = (sysFreq/2 + spiClk - 1) / spiClk;
#endif
...
PUBLIC VOID HAL_FUNC_INTERNAL hal_RfspiFillFifo(BOOL nextFrame)
{
    ...
    HAL_ASSERT(spaceLeft >= 0, "RFSPI IFC error: spaceLeft=%d", spaceLeft);
...
BOOL rfd_XcvRegForceWrite32k(void)//warkey 2.1
{
    BOOL result = FALSE;
    UINT32 data;
    UINT32 status = hal_SysEnterCriticalSection();
    ...
    {
        rfd_XcvRegForceWriteSingle(0x3f, 3);
	 xcvReadReg(0X01, (UINT8 *)&data);
        rfd_XcvRegForceWriteSingle(0X01, data&(~(1<<4)));
	 xcvReadReg(0X04, (UINT8 *)&data);
        rfd_XcvRegForceWriteSingle(0X04, (data&(~(0x1f<<13)))|(0xa<<13));		
