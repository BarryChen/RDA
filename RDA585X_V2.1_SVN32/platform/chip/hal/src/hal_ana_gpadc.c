...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  $HeadURL: http://svn.rdamicro.com/svn/developing1/Workspaces/aint/bv5_dev/platform/chip/hal/src/hal_ana_gpadc.c $ //
//    $Author: admin $                                                       //
...
//			hal_HstSendEvent(SYS_EVENT, 0x13061101);
//			hal_HstSendEvent(SYS_EVENT, x1);
//			hal_HstSendEvent(SYS_EVENT, x2);

			x1 &= 0x3ff;
			x2 &= 0x3ff;			

//			hal_HstSendEvent(SYS_EVENT, 0x13061102);
//			hal_HstSendEvent(SYS_EVENT, x1);
//			hal_HstSendEvent(SYS_EVENT, x2);
        }
        else
...
PUBLIC UINT16 hal_AnaGpadcGetRaw(HAL_ANA_GPADC_CHAN_T channel)
{
    ...
    do
    {
        ...
        if ((reg & CFG_REGS_GPADC_CH_EN) && (reg & CFG_REGS_GPADC_VALID))
        {
