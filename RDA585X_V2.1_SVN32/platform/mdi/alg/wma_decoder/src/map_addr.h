...
#define WMADECODE_GLOBAL_X_SIZE                           		9554
...
#define WMADECODE_LOCAL_X_BEGIN_ADDR                      		(9554 + RAM_X_BEGIN_ADDR)
#define WMADECODE_LOCAL_Y_BEGIN_ADDR                      		(10030 + RAM_Y_BEGIN_ADDR)
#define COMMON_LOCAL_X_BEGIN_ADDR                         		(9554 + RAM_X_BEGIN_ADDR)
...
//RAM_X: size 0x2800, used 0x273c	RAM_Y: size 0x2800, used 0x272e
