...
#ifndef VPPP_SPEECH_BT_H
#define VPPP_SPEECH_BT_H
...
typedef struct
{
	...
	INT16 Aec_AF_Conv_Enable;
	
	INT16 Aec_AF_Conv_Time1;
	INT16 Aec_AF_Conv_Time2;
	
	INT16 Aec_AF_Frame_Count;

	INT16 Aec_AF_Speaker_TH;
	
	INT16 Aec_AF_Echo_Gain_Step;

	INT16 Aec_AF_Echo_Gain_Limit;
