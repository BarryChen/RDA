...
#include "vppp_speech_common_bt.h"
...
void Coolsand_BT_AEC(void)
{
	...
	//AEC reset
	VoC_jal(Coolsand_BT_AECReset);

	VoC_lw16i(REG3,0x10);
	VoC_lw16i(REG4,0x7fff);
	VoC_lw16i_short(REG5,16,DEFAULT);
	VoC_bez16_d(Coolsand_BT_AEC_L1,m_AECProcPara_StrongEchoFlag)
...
Coolsand_BT_AEC_L0:		
		...
		//REG1:pMic
		//REG2:IntBuf
		VoC_jal(Coolsand_BT_EchoCancelProcessing);
	...
	VoC_bgt16_rr(Coolsand_BT_AEC_L0,REG2,REG5)
...
/**************************************************************************************
 * Function:    Coolsand_BT_GlobalReset
 *
 ...
 **************************************************************************************/
void Coolsand_BT_AECReset(void)
{
	VoC_push16(RA,DEFAULT);
	VoC_lw16_d(REG0,GLOBAL_RESET_ADDR);
	VoC_bez16_r(Coolsand_BT_AnalysisProcessing_L1,REG0)
...
Coolsand_BT_AnalysisProcessing_L1:
...
/**************************************************************************************
 * Function:    Coolsand_BT_EchoCancelProcessing
 *
...
void Coolsand_BT_EchoCancelProcessing(void)
{
	VoC_push16(RA,DEFAULT);
	...
	//REG5:g_SpkAnaFilterOutBufQ
	 ...
	 VoC_jal(Coolsand_BT_AnalysisProcessing);
...
Coolsand_BT_EchoCancelProcessing_L0:


	    // Filter
				
		VoC_jal(Coolsand_BT_AdaptiveFilteringAmp);


		// Update Spk Power

		VoC_jal(Coolsand_BT_UpdateSpkPower);
		...
		VoC_jal(Coolsand_BT_FilterUpdateCotrol_Int);
		...
		VoC_jal(Coolsand_BT_UpdateFilterAmp);
		...
		VoC_bgt16_rr(Coolsand_BT_EchoCancelProcessing_L0,REG2,REG1)
			...
			VoC_jal(Coolsand_BT_SumInstantPower);
			...
			VoC_jal(Coolsand_BT_ControlLogicDTD);	
			...
			VoC_bnez16_r(Coolsand_BT_EchoCancelProcessing_L3,REG0)
			VoC_bltz32_d(Coolsand_BT_EchoCancelProcessing_L3,r_PF_CL_DTDDecision)
				VoC_sw16_d(REG1,PFCLDTDOut);
Coolsand_BT_EchoCancelProcessing_L3:
			...
			VoC_jal(Coolsand_BT_ControlLogicMergeChnlEnhancedDTD);

			VoC_jal(Coolsand_BT_ControlLogicSingleChnlEnhanced);
...
Coolsand_BT_EchoCancelProcessing_L1:

		VoC_lw16_d(REG7,g_ch);
		VoC_jal(Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL);
			
		VoC_jal(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL);

		VoC_jal(Coolsand_BT_PostFiltering);
	...
	VoC_bgt16_rr(Coolsand_BT_EchoCancelProcessing_L1,REG2,REG1)
		//
		...
		VoC_bez16_r(Coolsand_BT_EchoCancelProcessing_L2,REG2)
		VoC_bne16_rr(Coolsand_BT_EchoCancelProcessing_L2,REG0,REG1)
			...
			VoC_startloop0
				...
				VoC_jal(Coolsand_BT_CmplxAppxNorm);
...
Coolsand_BT_EchoCancelProcessing_L2:
	...
	VoC_jal(Coolsand_BT_SynthesisProcessing);
...
/**************************************************************************************
 * Function:    Coolsand_BT_AnalysisProcessing
 *
...
void Coolsand_BT_AnalysisProcessing(void)
{
...
// VoC_directive: PARSER_ON
	...
	VoC_jal(Coolsand_BT_BackCopyVec);
...
/**************************************************************************************
 * Function:    Coolsand_BT_SynthesisProcessing
 *
 * Description: Analysis Filter Bank Operation
 *
 * Inputs:       
...
void Coolsand_BT_SynthesisProcessing(void)
{
...
/**************************************************************************************
 * Function:    Coolsand_BT_AdaptiveFiltering
 *
...
void Coolsand_BT_AdaptiveFilteringAmp(void)
{
...
/**************************************************************************************
 * Function:    Coolsand_BT_UpdateSpkPower
 *
 ...
 * Version 1.0  Created by  Guosz       07/29/2010
 **************************************************************************************/
void Coolsand_BT_UpdateSpkPower(void)
{
	VoC_push16(RA,DEFAULT);
	VoC_lw16i_short(INC0,1,DEFAULT);
	VoC_lw16i_short(INC1,1,IN_PARALLEL);
...
//	if (pSpkSigPower->d<0)
	VoC_bnltz32_r(Coolsand_BT_UpdateSpkPower100,ACC0)
//		pSpkSigPower->d = 0;
		VoC_lw32z(ACC0,DEFAULT);

Coolsand_BT_UpdateSpkPower100:
...
/**************************************************************************************
 * Function:    Coolsand_BT_FilterUpdateCotrol_Int
 *
 * Description: no
 *
 * Inputs:       
...
void Coolsand_BT_FilterUpdateCotrol_Int(void)
{
	...
	VoC_bnltz32_r(Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrI_abs,ACC0)
		VoC_lw32z(RL7,DEFAULT);
		VoC_sub32_rr(RL7,RL7,ACC0,DEFAULT);//RL7 :InstCorrI_Abs;
Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrI_abs:
 
    VoC_bngt32_rr(Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrI,RL7,REG45)
        VoC_movreg32(ACC0,REG45,DEFAULT);
		VoC_movreg32(RL7,ACC0,IN_PARALLEL);
		VoC_bgtz32_r(Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrI,RL7)
			VoC_lw16i_short(ACC0_HI,0xfff8,DEFAULT);
			VoC_lw16i_short(ACC0_LO,0x0,IN_PARALLEL);
Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrI:
   //ACC0  InstantCorrI

	VoC_movreg32(RL6,ACC1,DEFAULT);//RL6 :InstCorrQ_Abs;
   	VoC_bnltz32_r(Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrQ_abs,ACC1)
		VoC_lw32z(RL6,DEFAULT);
		VoC_sub32_rr(RL6,RL6,ACC1,DEFAULT);//RL6 :InstCorrQ_Abs;
Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrQ_abs:
 
    VoC_bngt32_rr(Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrQ,RL6,REG45)
		VoC_movreg32(ACC1,REG45,DEFAULT);
		VoC_movreg32(RL6,ACC1,IN_PARALLEL);
		VoC_bgtz32_r(Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrQ,RL6)
			VoC_lw16i_short(ACC1_HI,0xfff8,DEFAULT);
			VoC_lw16i_short(ACC1_LO,0x0,IN_PARALLEL);
Coolsand_BT_FilterUpdateCotrol_Int_InstantCorrQ:
    //ACC1  InstantCorrQ
...
//Those all are Q23
	 ...
	 VoC_lw32z(REG67,DEFAULT);
   	...
   	VoC_bnltz32_r(Coolsand_BT_FilterUpdateCotrol_Int_L0,REG01)
		VoC_sub32_rr(REG01,REG67,REG01,DEFAULT);
Coolsand_BT_FilterUpdateCotrol_Int_L0:    

   	VoC_bnltz32_r(Coolsand_BT_FilterUpdateCotrol_Int_L1,REG23)
		VoC_sub32_rr(REG23,REG67,REG23,DEFAULT);
Coolsand_BT_FilterUpdateCotrol_Int_L1:   
	
	VoC_lw16i_short(REG6,1,DEFAULT);

     VoC_bgt32_rr(Coolsand_BT_FilterUpdateCotrol_Int_L2,REG01,REG67)
     VoC_bngt32_rr(Coolsand_BT_FilterUpdateCotrol_Int_L3,REG23,REG67)//		if ( InstCorrI_Abs >1 || InstCorrQ_Abs >1 )
Coolsand_BT_FilterUpdateCotrol_Int_L2:
...
Coolsand_BT_FilterUpdateCotrol_Int_L3:
...
//Those all are Q23
	...
	// Update Spk Sig Smooth Power
     ...
     VoC_bez32_r(Coolsand_BT_FilterUpdateCotrol_Int_SpkDataPower,ACC0)//	if (SpkDataPower!=0)
...
Coolsand_BT_FilterUpdateCotrol_Int_SpkDataPower:
    ...
    VoC_jal(Coolsand_BT_CmplxAppxNorm_int); // 	CmplxAppxNorm( (int *) &(pRErrSpkI->d), (int *)&(pRErrSpkQ->d), &RErrSpkNorm );
    ...
    VoC_bnez32_r(Coolsand_BT_FilterUpdateCotrol_Int_RErrSpkNorm,ACC0)

// RL7:  pRErrSpkI->d  == LastCorrI
//RL6 : pRErrSpkQ->d  == LastCorrQ
       VoC_movreg32(ACC0,RL7,DEFAULT);

       VoC_jal(Coolsand_BT_CmplxAppxNorm_int);// CmplxAppxNorm( &LastCorrI, &LastCorrQ, &RErrSpkNorm );
       VoC_shr32_ri(ACC0,8,DEFAULT);  //	RErrSpkNorm = RErrSpkNorm >> (RErrSpkFracBitNum-CFFracBitNum);
       VoC_bnez32_r(Coolsand_BT_FilterUpdateCotrol_Int_RErrSpkNorm_100,ACC0)  
       VoC_lw16i_short(ACC0_LO,2,DEFAULT);
Coolsand_BT_FilterUpdateCotrol_Int_RErrSpkNorm_100:
       VoC_movreg32(RL6,REG23,DEFAULT); //LastSpkSmoothPower   SpkSigSmoothPower_r = LastSpkSmoothPower*FilterFactor;

Coolsand_BT_FilterUpdateCotrol_Int_RErrSpkNorm:
	...
	// Coupling factor
       VoC_bnez32_r(Coolsand_BT_FilterUpdateCotrol_Int_SpkSigSmoothPower_r,RL6)//	if (SpkSigSmoothPower_r == 0)
           VoC_lw16i_short(RL6_LO,1,DEFAULT);                       //    SpkSigSmoothPower_r = 1;
Coolsand_BT_FilterUpdateCotrol_Int_SpkSigSmoothPower_r:

	     VoC_lw16i_short(REG2,12,DEFAULT);//xuml
		 VoC_jal(Coolsand_BT_MSBPos);  //	int SpkSmoothPowerFirstBitPos = MSBPos(SpkSigSmoothPower_r, SpkSthPowerFracBitNum);
   ...
   //        VoC_lw16i_short(REG5,0,IN_PARALLEL);
    ...
    //   VoC_bgt32_rr(Coolsand_BT_FilterUpdateCotrol_Int_CouplingFactor,REG45,ACC0)  //	if (CouplingFactor >= (0x1<<CFFracBitNum) )
     //     VoC_lw32z(ACC0,DEFAULT);
	 //     VoC_lw16i(ACC0_LO,0x7fff);                             // 	CouplingFactor = (0x1<<CFFracBitNum)-1; 
//Coolsand_BT_FilterUpdateCotrol_Int_CouplingFactor:
	...
	VoC_jal(Coolsand_BT_CmplxAppxNorm_int);   // 	CmplxAppxNorm(&ErrDataI, &ErrDataQ, &ErrDataNorm);
    // ACC0 :  ErrDataNorm
	...
	// Sqrt Spk Sig Power
     ...
     VoC_bgt32_rr(Coolsand_BT_FilterUpdateCotrol_Int_SpkSigPower_s,REG45,RL6)// if (SpkSigPower_s>= (0x1<<(SpkPowShortTotalBitNum-1)))
		VoC_lw16i(RL6_LO,0x7ff);                                               //	SpkSigPower_s = (0x1<<(SpkPowShortTotalBitNum-1))-1;
		VoC_lw16i_short(RL6_HI,0,DEFAULT);

 Coolsand_BT_FilterUpdateCotrol_Int_SpkSigPower_s:
     VoC_bnez32_r(Coolsand_BT_FilterUpdateCotrol_Int_SpkSigPower_s_100,RL6)  //if (SpkSigPower_s == 0)
        VoC_lw16i_short(RL6_LO,1,DEFAULT);                       // 	SpkSigPower_s = 1;
Coolsand_BT_FilterUpdateCotrol_Int_SpkSigPower_s_100:

	
         VoC_lw16i_short(REG2,12,DEFAULT);//xuml
        VoC_jal(Coolsand_BT_MSBPos); // int SpkPowerFirstBitPos = MSBPos( SpkSigPower_s,SpkPowShortTotalBitNum-1);
	...
	VoC_bez16_r(Coolsand_BT_FilterUpdateCotrol_Int_SpkPowerFirstBitPos,REG4)// if ((SpkPowerFirstBitPos-1-SpkPowShortFracBitNum)%2 != 0)
		...
		VoC_jump(Coolsand_BT_FilterUpdateCotrol_Int_SpkPowerFirstBitPos_end)


Coolsand_BT_FilterUpdateCotrol_Int_SpkPowerFirstBitPos:
...
Coolsand_BT_FilterUpdateCotrol_Int_SpkPowerFirstBitPos_end:
       VoC_lw16i_short(ACC1_LO,0,DEFAULT);
       VoC_lw16i(ACC1_HI,0x0010);
 
	VoC_bgt32_rr(Coolsand_BT_FilterUpdateCotrol_Int_InstantCouplingFactor,ACC1,ACC0)//	if (InstantCouplingFactor>= (0x1<<(InstantCFTotalBitNum-1)) )
...
Coolsand_BT_FilterUpdateCotrol_Int_InstantCouplingFactor:
	  ...
	  VoC_bgt16_rr(Coolsand_BT_FilterUpdateCotrol_Int_FrameCnt_end,REG2,REG6) //	if (FrameCnt<FILTER_LEN)
	  VoC_bgt32_rr(Coolsand_BT_FilterUpdateCotrol_Int_FrameCnt_end, ACC1,ACC0)// if (CouplingFactor> ( InstantCouplingFactor<<(CFFracBitNum-InstantCFFracBitNum) ))

             //input : RL6, REG2
            //output: REG3
            VoC_movreg32(RL6,ACC0,DEFAULT);
	        VoC_lw16i_short(REG2,21,DEFAULT);//xuml
			VoC_jal(Coolsand_BT_MSBPos);                    //	int InstantCFFirstBitPos = MSBPos(InstantCouplingFactor, InstantCFTotalBitNum-1);
            VoC_lw16i_short(REG2,16,DEFAULT);
            ...
            VoC_lw16i(REG4,0x80);
	  VoC_bgt16_rr(Coolsand_BT_FilterUpdateCotrol_Int_FrameCnt_end,REG4,REG5)// if (pVarStepSize->d >= (0x1<<pVarStepSize->f) )
			 VoC_lw16i(REG5,0x7f);   //  pVarStepSize->d = (0x1<<pVarStepSize->f)-1;
Coolsand_BT_FilterUpdateCotrol_Int_FrameCnt_end: 
    VoC_pop16(RA,DEFAULT);
...
/**************************************************************************************
 * Function:    Coolsand_BT_UpdateFilter
 *
 ...
 * Version 1.1  optimized by  Cuilf     08/14/2010
 **************************************************************************************/
void Coolsand_BT_UpdateFilterAmp(void)
{
	...
	VoC_bgtz16_r(Coolsand_BT_ShrinkBit_abs,REG5)
		VoC_lw16i_short(REG3,0,DEFAULT);
		VoC_sub16_rr(REG5,REG3,REG5,DEFAULT);
Coolsand_BT_ShrinkBit_abs:


	VoC_movreg16(RL6_LO,REG5,DEFAULT);

	VoC_jal(Coolsand_BT_MSBPos);//xuml
	VoC_lw16i_short(REG4,0,DEFAULT);

	VoC_bez16_r(Coolsand_BT_ShrinkBit_end,REG3)
	...
	Coolsand_BT_ShrinkBit_end:

	//input : RL6, REG2
	//output: REG3
	VoC_movreg16(RL6_LO,REG4,DEFAULT);
	//	 VoC_lw16i_short(REG2,7,DEFAULT);
	VoC_jal(Coolsand_BT_MSBPos);              //int SpkPowerFirstBitPos = MSBPos( SpkSigPower_r.d,SpkSigPower_r.t-1);
	...
	VoC_bgt16_rr(Coolsand_BT_UpdateFilterAmp_L1,REG0,REG1)
		VoC_lw16i(REG1,0x4000);
	VoC_jump(Coolsand_BT_UpdateFilterAmp_End);
Coolsand_BT_UpdateFilterAmp_L1:

	VoC_lw16i_short(REG1,2,DEFAULT);
	VoC_bgt16_rr(Coolsand_BT_UpdateFilterAmp_L2,REG0,REG1)
		VoC_lw16i(REG1,0x2000);
	VoC_jump(Coolsand_BT_UpdateFilterAmp_End);
Coolsand_BT_UpdateFilterAmp_L2:

	VoC_lw16i_short(REG1,3,DEFAULT);
	VoC_bgt16_rr(Coolsand_BT_UpdateFilterAmp_L3,REG0,REG1)
		VoC_lw16i(REG1,0x1555);
	VoC_jump(Coolsand_BT_UpdateFilterAmp_End);
Coolsand_BT_UpdateFilterAmp_L3:

	VoC_lw16i_short(REG1,4,DEFAULT);
	VoC_bgt16_rr(Coolsand_BT_UpdateFilterAmp_L4,REG0,REG1)
		VoC_lw16i(REG1,0x1000);
	VoC_jump(Coolsand_BT_UpdateFilterAmp_End);
Coolsand_BT_UpdateFilterAmp_L4:

	VoC_lw16i_short(REG1,5,DEFAULT);
	VoC_bgt16_rr(Coolsand_BT_UpdateFilterAmp_L5,REG0,REG1)
		VoC_lw16i(REG1,0xccc);
	VoC_jump(Coolsand_BT_UpdateFilterAmp_End);
Coolsand_BT_UpdateFilterAmp_L5:

		VoC_lw16i_short(REG1,6,DEFAULT);
	VoC_bgt16_rr(Coolsand_BT_UpdateFilterAmp_L6,REG0,REG1)
		VoC_lw16i(REG1,0xaaa);
	VoC_jump(Coolsand_BT_UpdateFilterAmp_End);
Coolsand_BT_UpdateFilterAmp_L6:

	VoC_lw16i_short(REG1,7,DEFAULT);
	VoC_bgt16_rr(Coolsand_BT_UpdateFilterAmp_L7,REG0,REG1)
		VoC_lw16i(REG1,0x924);
	VoC_jump(Coolsand_BT_UpdateFilterAmp_End);
Coolsand_BT_UpdateFilterAmp_L7:
	VoC_lw16i(REG1,0x800);
Coolsand_BT_UpdateFilterAmp_End:
...
/**************************************************************************************
 * Function:    Coolsand_BT_BackCopyVec
 *
 ...
 * Version 1.0  Created by  Xuml       07/23/2010
 **************************************************************************************/
void Coolsand_BT_BackCopyVec(void)
{
	VoC_lw16i_short(INC1,-2,DEFAULT);
	VoC_lw16i_short(INC2,-2,IN_PARALLEL);
 ...
 **************************************************************************************/
void Coolsand_BT_ClearVec(void)
{
	VoC_lw16i_short(INC1,2,DEFAULT);
...
void Coolsand_BT_IFFT16(void)
{
	...
	//reverse real
	VoC_jal(Coolsand_BT_ReverseIndex);
	...
	VoC_loop_i(1,2)
		...
		VoC_startloop0
			...
			VoC_boe0z16_r(Coolsand_BT_IFFT16_L0)
				VoC_lw32z(RL7,DEFAULT);
Coolsand_BT_IFFT16_L0:

			VoC_boe1z16_r(Coolsand_BT_IFFT16_L1)
				VoC_lw32z(RL6,DEFAULT);
Coolsand_BT_IFFT16_L1:
...
/**************************************************************************************
 * Function:    Coolsand_BT_ReverseIndex
 *
 ...
 **************************************************************************************/
void Coolsand_BT_ReverseIndex(void)
{
...
/**************************************************************************************
 * Function:    Coolsand_BT_CmplxAppxNorm_int
 *
 * Description: no
 *
 * Inputs:       
 ...
 **************************************************************************************/
void Coolsand_BT_CmplxAppxNorm_int(void)
{
   ...
   VoC_bgt32_rr(Coolsand_BT_CmplxAppxNorm_int_300,ACC0,ACC1)
     VoC_movreg32(ACC0,ACC1,DEFAULT);
     VoC_movreg32(ACC1,ACC0,IN_PARALLEL);//swap
Coolsand_BT_CmplxAppxNorm_int_300:
...
void Coolsand_BT_MSBPos(void)
{
	...
	VoC_lw16i_short(INC3,1,IN_PARALLEL);
	VoC_startloop0
		VoC_bez32_r(Coolsand_BT_MSBPos_L0,ACC0)
		VoC_inc_p(REG3,DEFAULT);
		VoC_shr32_ri(ACC0,1,IN_PARALLEL);
	VoC_endloop0

Coolsand_BT_MSBPos_L0:
	VoC_pop32(ACC0,DEFAULT);
...
/**************************************************************************************
 * Function:    Coolsand_BT_NonLinearTransform
 *
 * Description: no
 *
 * Inputs:       
...
/*
void Coolsand_BT_NonLinearTransform(void)
{
...
//	VoC_lw16i(REG7,NonLinearTransform_T_HI);
	...
	VoC_loop_i(0,DEF_DATA_BLOCK_SIZE)
		...
		VoC_bnlt32_rd(Coolsand_BT_NonLinearTransform_L0,ACC0,Minus_UpLimit)
			...
			VoC_jump(Coolsand_BT_NonLinearTransform_End);
Coolsand_BT_NonLinearTransform_L0:


		VoC_bgt32_rd(Coolsand_BT_NonLinearTransform_L1,ACC0,Minus_DnLimit)
			...
			VoC_jump(Coolsand_BT_NonLinearTransform_End);
Coolsand_BT_NonLinearTransform_L1:
			
		VoC_bnlt32_rd(Coolsand_BT_NonLinearTransform_L2,ACC0,DnLimit)
			...
			VoC_jump(Coolsand_BT_NonLinearTransform_End);
Coolsand_BT_NonLinearTransform_L2:


		VoC_bgt32_rd(Coolsand_BT_NonLinearTransform_L3,ACC0,UpLimit)
			...
			VoC_shr32_ri(ACC0,-16,DEFAULT);
			VoC_jump(Coolsand_BT_NonLinearTransform_End);
Coolsand_BT_NonLinearTransform_L3:

		VoC_lw16_d(ACC0_HI,NonLinear_Scale_ADDR);
		
		VoC_NOP();		
Coolsand_BT_NonLinearTransform_End:
		VoC_sw16inc_p(ACC0_HI,REG0,DEFAULT);
...
/**************************************************************************************
 * Function:    Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL
 *
 * Description:  
 *
 * Inputs:       
 ...
 **************************************************************************************/
void Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL(void)
{
	VoC_push16(RA,DEFAULT);
	...
	VoC_jal(Coolsand_BT_InstantPower);
	...
	VoC_jal(Coolsand_BT_SmoothPeakPower);
	...
	// Instant Err SNR
	VoC_jal(Coolsand_BT_InstantSNR); 

	//REG3:InstantSToNRatio
	
	//Spk  Noise Power Est
	VoC_jal(Coolsand_BT_OverallNoiseEstwState);
	...
	VoC_bnez32_r(Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L0,REG23)
		VoC_lw16i_short(REG2,1,DEFAULT); 
		VoC_lw16i_short(REG3,0,IN_PARALLEL);
Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L0:

	// Compute Noise Power Reverse
	VoC_jal(Coolsand_BT_ShrinkBit);
	...
	VoC_bez32_r(Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L1,RL6)
		VoC_add32_rr(REG67,REG67,RL7,DEFAULT);
Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L1:
...
//	VoC_movreg16(REG5,REG6,IN_PARALLEL);
	...
	VoC_bnltz32_r(Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L2,RL7)
		VoC_lw32z(RL7,DEFAULT);
Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L2:
...
//	VoC_jal(Coolsand_BT_FirstOrderIIRSmooth2);
...
//		pPriorSToNRatio->d = (0x1<<(pPriorSToNRatio->t-1))-1;
	...
	VoC_bngt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L3,REG2,REG1)

		//Mul_SNRWeight = *pPriorSToNRatio*(NoiseWeight_r);
		VoC_multf16_rr(REG0,REG0,REG1,DEFAULT);
		VoC_lw16i_short(FORMAT16,7-16,IN_PARALLEL);

Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L3:
	...
	VoC_bngt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L4,REG2,REG1)
		VoC_sub16_rr(REG5,REG2,REG1,DEFAULT);	
Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L4:
	...
	VoC_bgt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L5,REG5,REG0)
		VoC_movreg16(REG5,REG0,DEFAULT);	
Coolsand_BT_ComputeNoiseWeight_DeciDirectCTRL_L5:	
...
/**************************************************************************************
 * Function:    Coolsand_BT_ComputeNoiseWeight_DeciDirect
 *
...
/*
void Coolsand_BT_ComputeNoiseWeight_DeciDirect(void)
{
	VoC_push16(RA,DEFAULT);
	...
	VoC_bnez32_r(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L0,RL6)
		VoC_lw16i_short(RL6_LO,1,DEFAULT);
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L0:	
	...
	VoC_jal(Coolsand_BT_NoisePSDEst);
	...
	VoC_bez32_r(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L1,RL6)
		...
		VoC_bngt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L2,REG0,REG3)
		VoC_bne32_rr  (Coolsand_BT_ComputeNoiseWeight_DeciDirect_L2,ACC1,ACC0)

			VoC_lw16i_short(REG4,1,DEFAULT);	
			VoC_add16_rp(REG1,REG4,REG2,DEFAULT);
			
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L2:
		VoC_lw16i(REG5,500);
		VoC_bngt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L3,REG1,REG5)
			//*pNoiseFloorDevCnt = 0;
...
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L3:
			VoC_sw16_p(REG1,REG2,DEFAULT);

Coolsand_BT_ComputeNoiseWeight_DeciDirect_L1:
	...
	VoC_bnez32_r(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L4,ACC1)
		VoC_lw16i_short(ACC1_LO,1,DEFAULT);
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L4:
	...
	VoC_bnltz32_r(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L5,ACC0)
		VoC_lw32z(ACC0,DEFAULT);
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L5:
...
//	VoC_jal(Coolsand_BT_FirstOrderIIRSmooth2);
	...
	VoC_bngt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L6,REG5,REG2)
		VoC_multf16_rr(REG4,REG2,REG0,DEFAULT);		
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L6:
...
//	VoC_bez16_r(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L7,REG4)
//		VoC_movreg16(RL6_HI,REG4,DEFAULT);
//Coolsand_BT_ComputeNoiseWeight_DeciDirect_L7:
	...
	VoC_bngt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L8,REG2,REG1)
		VoC_sub16_rr(REG4,REG2,REG1,DEFAULT);		
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L8:

	VoC_bgt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L11,REG4,REG7)
		VoC_movreg16(REG4,REG7,DEFAULT);
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L11:

	VoC_lw16_d(REG2,AmpThr_ADDR);
	VoC_bngt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L9,REG2,REG7)
		VoC_movreg16(REG2,REG7,DEFAULT);
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L9:


	VoC_movreg16(REG6,REG4,DEFAULT);
	VoC_shr16_ri(REG6,-4,DEFAULT);
	
	VoC_bngt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L10,REG4,REG2)
		VoC_multf16_rd(REG6,REG4,m_AECProcPara_AmpGain);
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L10:
...
/*
	...
	VoC_bgt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L9,REG7,REG4)
		VoC_multf16_rd(REG6,REG4,m_AECProcPara_AmpGain);
		VoC_jump(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L10);
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L9:

	VoC_bngt16_rd(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L10,REG4,m_AECProcPara_NoiseGainLimit)
		VoC_movreg16(REG6,REG4,DEFAULT);
		VoC_shr16_ri(REG6,-4,DEFAULT);
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L10:
...
/*	
	...
	VoC_bgt16_rd(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L9,REG4,m_AECProcPara_NoiseGainLimit)
		VoC_lw16_d(REG4,m_AECProcPara_NoiseGainLimit);
Coolsand_BT_ComputeNoiseWeight_DeciDirect_L9:

		VoC_lw16_d(REG7,m_AECProcPara_NoiseGainLimit);
		VoC_shr16_ri(REG7,-4,DEFAULT);
	VoC_bgt16_rr(Coolsand_BT_ComputeNoiseWeight_DeciDirect_L10,REG6,REG7)
...
/**************************************************************************************
 * Function:    Coolsand_BT_CmplxAppxNorm
 *
 * Description:  no
 *
 * Inputs:       
 ...
 * Version 1.0  Created by  Xuml       08/23/2010
 **************************************************************************************/
void Coolsand_BT_CmplxAppxNorm(void)
{
	...
	VoC_bgt16_rr(Coolsand_BT_CmplxAppxNorm_L0,REG2,REG3)

		VoC_movreg16(REG2,REG3,DEFAULT);
		VoC_movreg16(REG3,REG2,IN_PARALLEL);

Coolsand_BT_CmplxAppxNorm_L0:
...
/**************************************************************************************
 * Function:    Coolsand_BT_FirstOrderIIRSmooth2
 *
 * Description:  no
 *
 * Inputs:       
 ...
 * Version 1.0  Created by  Xuml       08/23/2010
 **************************************************************************************/
void Coolsand_BT_FirstOrderIIRSmooth2(void)
{
...
/**************************************************************************************
 * Function:    Coolsand_BT_NoisePSDEst
 *
 * Description:  no
 *
 * Inputs:       
 ...
 **************************************************************************************/
void Coolsand_BT_NoisePSDEst(void)
{
	...
	VoC_bngt16_rr(Coolsand_BT_NoisePSDEst_L0,REG7,REG6)
		
		VoC_movreg32(ACC1,ACC0,DEFAULT);

		VoC_jump(Coolsand_BT_NoisePSDEst_Lx);
Coolsand_BT_NoisePSDEst_L0:

		VoC_bngt32_rr(Coolsand_BT_NoisePSDEst_L1,ACC1,ACC0)

			VoC_bez32_r(Coolsand_BT_NoisePSDEst_L1_sub0,ACC0)

				VoC_movreg32(ACC1,ACC0,DEFAULT);

				VoC_jump(Coolsand_BT_NoisePSDEst_Lx);
Coolsand_BT_NoisePSDEst_L1_sub0:
...
Coolsand_BT_NoisePSDEst_L1:
		...
		VoC_bgt32_rr(Coolsand_BT_NoisePSDEst_L2,ACC1,RL6)
			
			VoC_movreg16(REG7,REG4,DEFAULT);
			VoC_jump(Coolsand_BT_NoisePSDEst_L4);
Coolsand_BT_NoisePSDEst_L2:

		VoC_lw16i_short(RL6_HI,0,DEFAULT);
		VoC_lw16i_short(RL6_LO,32,IN_PARALLEL);

		VoC_bngt32_rr(Coolsand_BT_NoisePSDEst_L3,RL6,ACC1)
			VoC_movreg16(REG7,REG5,DEFAULT);
			VoC_jump(Coolsand_BT_NoisePSDEst_L4);
Coolsand_BT_NoisePSDEst_L3:
...
Coolsand_BT_NoisePSDEst_L4:
		...
		VoC_bez32_r(Coolsand_BT_NoisePSDEst_Lx,RL7)
...
Coolsand_BT_NoisePSDEst_Lx:

	VoC_lw16i_short(RL6_LO,4,DEFAULT);
	VoC_lw16i_short(RL6_HI,0,IN_PARALLEL);

	VoC_bgt32_rr(Coolsand_BT_NoisePSDEst_END,ACC1,RL6)
		VoC_movreg32(ACC1,RL6,DEFAULT);		
Coolsand_BT_NoisePSDEst_END:
...
/**************************************************************************************
 * Function:    Coolsand_BT_ShrinkBit
 *
 * Description:  no
 *
 * Inputs:       
...
void Coolsand_BT_ShrinkBit(void)
{
	...
	VoC_bez16_r(Coolsand_BT_ShrinkBit_L0,REG3)
...
/**************************************************************************************
 * Function:    Coolsand_BT_PostFiltering
 *
 * Description:  no
 *
 * Inputs:       
...
void Coolsand_BT_PostFiltering(void)
{
	VoC_push16(RA,DEFAULT);
	...
	VoC_bngt16_rr(Coolsand_BT_PostFiltering_L0,REG4,REG3)

		VoC_movreg16(REG4,REG3,DEFAULT);
	
Coolsand_BT_PostFiltering_L0:

	VoC_shr16_ri(REG4,-7,DEFAULT);

	VoC_bngt16_rr(Coolsand_BT_PostFiltering_L1,REG0,REG4)

		VoC_mult16_rd(REG1,REG1,m_AECProcPara_AmpGain);//*pNoiseAmpWeight = (*pNoiseWeight)*AmpGain;
		VoC_jump(Coolsand_BT_PostFiltering_L2)	;
Coolsand_BT_PostFiltering_L1:	
		VoC_shr16_ri(REG1,-4,DEFAULT);
Coolsand_BT_PostFiltering_L2:	
...
//	VoC_add16_rr(REG5,REG5,REG7,IN_PARALLEL);	
	...
	VoC_bgt32_rd(Coolsand_BT_PostFiltering_L3,ACC1,m_AECProcPara_NoiseMin)
		VoC_lw32_d(ACC1,m_AECProcPara_NoiseMin);
Coolsand_BT_PostFiltering_L3:
	...
	VoC_bez16_r(Coolsand_BT_PostFiltering_L5,REG3)
		...
		VoC_bez16_r(Coolsand_BT_PostFiltering_L4,REG2)
			...
			VoC_jump(Coolsand_BT_PostFiltering_L5);
Coolsand_BT_PostFiltering_L4:
...
Coolsand_BT_PostFiltering_L5:
	...
	VoC_bez32_d(Coolsand_BT_PostFiltering_L8,m_AECProcPara_NoiseMin)
		VoC_lw16i(ACC1_LO,0x5b);
Coolsand_BT_PostFiltering_L8:
	
	VoC_bngt32_rr(Coolsand_BT_PostFiltering_L6,ACC1,ACC0)

		VoC_movreg32(ACC0,ACC1,DEFAULT);

Coolsand_BT_PostFiltering_L6:	
	...
	VoC_bne16_rd(Coolsand_BT_PostFiltering_L9,REG6,r_PF_CL_State)	
	VoC_bgt16_rd(Coolsand_BT_PostFiltering_L7,REG6,g_ch)
Coolsand_BT_PostFiltering_L9:		
	VoC_bngt16_rr(Coolsand_BT_PostFiltering_L7,REG0,REG1)

		//REG0[out]
		//REG1[out]
		VoC_jal(Coolsand_BT_Generate);
		...
		VoC_jump(Coolsand_BT_PostFiltering_End);

Coolsand_BT_PostFiltering_L7:
		//REG0[out]
		//REG1[out]
		VoC_jal(Coolsand_BT_Generate);

Coolsand_BT_PostFiltering_End:
	VoC_pop16(RA,DEFAULT);
...
void Coolsand_BT_Generate(void)
{
...
/**************************************************************************************
 * Function:    Coolsand_BT_SumInstantPower
 *
 * Description: 
 *
 * Inputs:  REG2:     
...
void Coolsand_BT_SumInstantPower(void)
{
	VoC_push16(RA,DEFAULT);
...
/**************************************************************************************
 * Function:    Coolsand_BT_InstantPower
 *
 * Description: 
 *
 * Inputs:  REG0:     
 ...
 * Version 1.0  Created by  Xuml       04/19/2011
 **************************************************************************************/
void Coolsand_BT_InstantPower(void)
{	
	VoC_push16(RA,DEFAULT);
...
/**************************************************************************************
 * Function:    Coolsand_BT_ControlLogicMergeChnlEnhancedDTD
 *
 * Description: 
 *
 * Inputs:  REG0:     
 ...
 **************************************************************************************/
void Coolsand_BT_ControlLogicMergeChnlEnhancedDTD(void)
{
	VoC_push16(RA,DEFAULT);
	VoC_push32(ACC0,IN_PARALLEL);

	VoC_jal(Coolsand_BT_ControlLogicCalVarSub);
	...
	VoC_jal(Coolsand_BT_ControlLogicChnlDecisionEnhanced);
...
/**************************************************************************************
 * Function:    Coolsand_BT_ControlLogicSingleChnlEnhanced
 *
 * Description: 
 *
 * Inputs:  REG0:     
 ...
 **************************************************************************************/
void Coolsand_BT_ControlLogicSingleChnlEnhanced(void)
{
	VoC_push16(RA,DEFAULT);
	...
	VoC_bne16_rd(Coolsand_BT_ControlLogicSingleChnl_L1,REG0,r_PF_CL_ChnlState)

		VoC_lw16_d(REG4,r_PF_CL_DTCountUp);
		VoC_lw16_d(REG5,m_AECProcPara_PFCLDTStartTime);

		VoC_bgt16_rr(Coolsand_BT_ControlLogicSingleChnl_L0,REG5,REG4)

		VoC_lw16i_short(REG1,2,DEFAULT);
		VoC_movreg16(REG4,REG5,IN_PARALLEL);
		VoC_lw16_d(REG2,m_AECProcPara_PFCLDTHoldTime);
		
		VoC_jump(Coolsand_BT_ControlLogicSingleChnl_End);		

Coolsand_BT_ControlLogicSingleChnl_L0:
		...
		VoC_jump(Coolsand_BT_ControlLogicSingleChnl_End);		
Coolsand_BT_ControlLogicSingleChnl_L1:

	VoC_lw16i_short(REG0,1,DEFAULT);

	VoC_bne16_rd(Coolsand_BT_ControlLogicSingleChnl_L4,REG0,r_PF_CL_ChnlState)


		VoC_lw16_d(REG4,r_PF_CL_DTCountUp);
		VoC_lw16_d(REG5,m_AECProcPara_PFCLDTStartTime);

		VoC_bngt16_rr(Coolsand_BT_ControlLogicSingleChnl_L2,REG5,REG4)
			VoC_lw16i_short(REG4,0,DEFAULT);
Coolsand_BT_ControlLogicSingleChnl_L2:
		
		VoC_bnez16_d(Coolsand_BT_ControlLogicSingleChnl_L3,r_PF_CL_DTCountDown)
			VoC_lw16i_short(REG1,1,DEFAULT);
			VoC_lw16i_short(REG4,0,IN_PARALLEL);
			VoC_jump(Coolsand_BT_ControlLogicSingleChnl_End);			

Coolsand_BT_ControlLogicSingleChnl_L3:		
		VoC_lw16i_short(REG1,2,DEFAULT);
		VoC_inc_p(REG2,IN_PARALLEL);
		VoC_jump(Coolsand_BT_ControlLogicSingleChnl_End);		
Coolsand_BT_ControlLogicSingleChnl_L4:


	VoC_lw16i_short(REG0,3,DEFAULT);
	VoC_bne16_rd(Coolsand_BT_ControlLogicSingleChnl_L7,REG0,r_PF_CL_ChnlState)

		VoC_lw16_d(REG4,r_PF_CL_DTCountUp);
		VoC_lw16_d(REG5,m_AECProcPara_PFCLDTStartTime);

		VoC_bngt16_rr(Coolsand_BT_ControlLogicSingleChnl_L5,REG5,REG4)
			VoC_lw16i_short(REG4,0,DEFAULT);
Coolsand_BT_ControlLogicSingleChnl_L5:

		VoC_bnez16_d(Coolsand_BT_ControlLogicSingleChnl_L6,r_PF_CL_DTCountDown)
			VoC_lw16i_short(REG1,3,DEFAULT);
			VoC_lw16i_short(REG4,0,IN_PARALLEL);
			VoC_jump(Coolsand_BT_ControlLogicSingleChnl_End);			

Coolsand_BT_ControlLogicSingleChnl_L6:		
		VoC_lw16i_short(REG1,2,DEFAULT);
		VoC_inc_p(REG2,IN_PARALLEL);
		VoC_jump(Coolsand_BT_ControlLogicSingleChnl_End);		
Coolsand_BT_ControlLogicSingleChnl_L7:


		VoC_lw16_d(REG4,r_PF_CL_DTCountUp);
		VoC_lw16_d(REG5,m_AECProcPara_PFCLDTStartTime);

		VoC_bngt16_rr(Coolsand_BT_ControlLogicSingleChnl_L8,REG5,REG4)
			VoC_lw16i_short(REG4,0,DEFAULT);
Coolsand_BT_ControlLogicSingleChnl_L8:


	VoC_bnez16_d(Coolsand_BT_ControlLogicSingleChnl_L9,r_PF_CL_DTCountDown)
		VoC_lw16i_short(REG1,0,DEFAULT);
		VoC_lw16i_short(REG4,0,IN_PARALLEL);
		VoC_jump(Coolsand_BT_ControlLogicSingleChnl_End);	
Coolsand_BT_ControlLogicSingleChnl_L9:		
	VoC_lw16i_short(REG1,2,DEFAULT);
	VoC_inc_p(REG2,IN_PARALLEL);
		
Coolsand_BT_ControlLogicSingleChnl_End:
...
/**************************************************************************************
 * Function:    Coolsand_BT_ControlLogicCalVarSub
 *
 * Description: 
 *
 ...
 * Version 1.0  Created by  Xuml       04/19/2011
 **************************************************************************************/
void Coolsand_BT_ControlLogicCalVarSub(void)
{
	VoC_push16(RA,DEFAULT);
	VoC_push32(RL6,IN_PARALLEL);
...
//	VoC_pop32(ACC0,DEFAULT);//PrevSpkSmoothPower
	...
	VoC_jal(Coolsand_BT_OverallNoiseEst);
...
/**************************************************************************************
 * Function:    Coolsand_BT_ControlLogicChnlDecisionEnhanced
 *
 * Description: 
 *
 * Inputs:       
 ...
 * Version 1.0  Created by  Xuml       04/22/2011
 **************************************************************************************/
void Coolsand_BT_ControlLogicChnlDecisionEnhanced(void)
{
	...
	VoC_bngt32_rr(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L0,ACC1,ACC0)
		VoC_lw16i_short(REG4,1,DEFAULT);
Coolsand_BT_ControlLogicChnlDecisionEnhanced_L0:
	...
	VoC_bngt32_rr(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L1,ACC1,ACC0)
	VoC_bnlt32_rd(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L1,REG67,r_PF_CL_SpkSmoothPower)
		VoC_lw16i_short(REG4,1,DEFAULT);
		VoC_NOP();
Coolsand_BT_ControlLogicChnlDecisionEnhanced_L1:

	VoC_sw16_d(REG4,r_PF_CL_ifSpkSigOn);

	// Compare Mic and Spk Power
	VoC_bnez16_d(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L2,r_PF_CL_ifSpkSigOn)
	VoC_bez16_d(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L2,r_PF_CL_ifMicSigOn)
	...
	VoC_bngt32_rr(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L2,ACC0,ACC1)
		// Near End Single Talk
			VoC_lw16i_short(REG0,1,DEFAULT);//*pState = 1;
			VoC_jump(Coolsand_BT_ControlLogicChnlDecisionEnhanced_End);		
Coolsand_BT_ControlLogicChnlDecisionEnhanced_L2:	



	VoC_bnez32_d(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L3,r_PF_CL_MicSmoothPower)
	VoC_bnez32_d(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L3,r_PF_CL_SpkSmoothPower)

		// Near End Single Talk
		VoC_lw16i_short(REG0,3,DEFAULT);//*pState = 3;
		VoC_jump(Coolsand_BT_ControlLogicChnlDecisionEnhanced_End);			
Coolsand_BT_ControlLogicChnlDecisionEnhanced_L3:
		

	VoC_bnez16_d(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L4,r_PF_CL_ifSpkSigOn)
	VoC_bnez16_d(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L4,r_PF_CL_ifMicSigOn)

		VoC_lw32_d(ACC0,r_PF_CL_MicSmoothPower);
		VoC_lw32_d(ACC1,r_PF_CL_SpkSmoothPower);

	VoC_bngt32_rr(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L4,ACC0,ACC1)

		// Near End Single Talk
		VoC_lw16i_short(REG0,3,DEFAULT);//*pState = 3;
		VoC_jump(Coolsand_BT_ControlLogicChnlDecisionEnhanced_End);			
Coolsand_BT_ControlLogicChnlDecisionEnhanced_L4:
/*
	...
	VoC_bgt32_rr(Coolsand_BT_ControlLogicChnlDecisionEnhanced_L5,ACC1,ACC0)
		...
		VoC_bngt32_rr(Coolsand_BT_ControlLogicChnlDecisionEnhanced_End,RL6,ACC1);
		VoC_bngt32_rr(Coolsand_BT_ControlLogicChnlDecisionEnhanced_End,ACC1,RL7);
			
			VoC_lw32_d(ACC0,r_PF_CL_SpkSmoothPower);
			VoC_lw32_d(ACC1,r_PF_CL_MicSmoothPower);

		VoC_bngt32_rr(Coolsand_BT_ControlLogicChnlDecisionEnhanced_End,ACC1,ACC0);

Coolsand_BT_ControlLogicChnlDecisionEnhanced_L5:

		VoC_lw16i_short(REG0,2,DEFAULT);
Coolsand_BT_ControlLogicChnlDecisionEnhanced_End:*/


		VoC_lw16i_short(REG0,2,DEFAULT);
	VoC_bnez16_d(Coolsand_BT_ControlLogicChnlDecisionEnhanced_End,PFCLDTDOut)
		VoC_lw16i_short(REG0,0,DEFAULT);
Coolsand_BT_ControlLogicChnlDecisionEnhanced_End:
...
/**************************************************************************************
 * Function:    Coolsand_BT_SmoothPeakPower
 *
 * Description: 
 *
 ...
 **************************************************************************************/
void Coolsand_BT_SmoothPeakPower(void)
{
	...
	VoC_bngt32_rr(Coolsand_BT_SmoothPeakPower_L0,RL7,ACC1)
	VoC_bngt32_rr(Coolsand_BT_SmoothPeakPower_L0,ACC0,RL7)

		VoC_movreg32(ACC0,RL7,DEFAULT);

		VoC_jump(Coolsand_BT_SmoothPeakPower_L1);

Coolsand_BT_SmoothPeakPower_L0:
...
Coolsand_BT_SmoothPeakPower_L1:

	VoC_bnltz32_r(Coolsand_BT_SmoothPeakPower_L2,ACC0)
		VoC_lw32z(ACC0,DEFAULT);	
Coolsand_BT_SmoothPeakPower_L2:
...
/**************************************************************************************
 * Function:    Coolsand_BT_InstantSNR
 *
 * Description: 
 *
 ...
 * Version 1.0  Created by  Xuml       04/20/2011
 **************************************************************************************/
void Coolsand_BT_InstantSNR(void)
{

	VoC_push16(RA,DEFAULT);	
	VoC_shr32_ri(ACC0,4,IN_PARALLEL);

	VoC_bnez32_r(Coolsand_BT_InstantSNR_L0,ACC0)
		VoC_lw16i_short(ACC0_LO,1,DEFAULT);
		VoC_lw16i_short(ACC0_HI,0,IN_PARALLEL);
Coolsand_BT_InstantSNR_L0:
	VoC_movreg32(RL6,ACC0,DEFAULT);
	VoC_lw16i_short(REG2,20,IN_PARALLEL);
	//RL6:NoisePower_r.d
	//REG2:oisePower_r.t
...
/**************************************************************************************
 * Function:    Coolsand_BT_OverallNoiseEst
 *
 * Description: 
 *
 ...
 * Version 1.0  Created by  Xuml       04/20/2011
 **************************************************************************************/
void Coolsand_BT_OverallNoiseEst(void)
{
	...
	//if (pSigPower->d!=0)
	VoC_bez32_r(Coolsand_BT_OverallNoiseEst_L2,ACC1)
		...
		VoC_bne32_rr(Coolsand_BT_OverallNoiseEst_L0,ACC1,ACC0);
		VoC_bngt16_rr(Coolsand_BT_OverallNoiseEst_L0,REG3,REG4);
			VoC_add16_rp(REG6,REG5,REG7,DEFAULT);		//*pNoiseFloorDevCnt = (*pNoiseFloorDevCnt) + 1;
Coolsand_BT_OverallNoiseEst_L0:

		VoC_lw16i(REG4,500*8);
		VoC_lw32_p(ACC1,REG1,DEFAULT);//pNoisePower->d
		VoC_shr32_ri(ACC1,-1,DEFAULT);
		VoC_bngt16_rr(Coolsand_BT_OverallNoiseEst_L1,REG6,REG4);

			VoC_lw16i_short(REG6,0,DEFAULT);
			VoC_sw32_p(ACC1,REG1,DEFAULT);

Coolsand_BT_OverallNoiseEst_L1:
		VoC_sw16_p(REG6,REG7,DEFAULT);//save pNoiseFloorDevCnt
		
Coolsand_BT_OverallNoiseEst_L2:
...
/**************************************************************************************
 * Function:    Coolsand_BT_OverallNoiseEstwState
 *
 * Description: 
 *
 * Inputs:  REG0:   pSigPower
 ...
 * Version 1.0  Created by  Xuml       04/25/2011
 **************************************************************************************/
void Coolsand_BT_OverallNoiseEstwState(void)
{
	VoC_lw16_d(REG7,g_ch);
	...
	VoC_bez16_d(Coolsand_BT_OverallNoiseEstwState_L0_subL0,m_AECProcPara_StrongEchoFlag)
	VoC_bne16_rd(Coolsand_BT_OverallNoiseEstwState_L0,REG4,r_PF_CL_State)
	
Coolsand_BT_OverallNoiseEstwState_L0_subL0:	
...
Coolsand_BT_OverallNoiseEstwState_L0:
	...
	//if (pSigPower->d!=0)
	VoC_bez32_r(Coolsand_BT_OverallNoiseEstwState_L3,ACC1)
		...
		VoC_bne32_rr(Coolsand_BT_OverallNoiseEstwState_L1,ACC1,ACC0);
		VoC_bngt16_rr(Coolsand_BT_OverallNoiseEstwState_L1,REG3,REG4);
			VoC_add16_rp(REG6,REG5,REG7,DEFAULT);		//*pNoiseFloorDevCnt = (*pNoiseFloorDevCnt) + 1;
Coolsand_BT_OverallNoiseEstwState_L1:

		VoC_lw16i(REG4,500*16);
		VoC_lw32_p(ACC1,REG1,DEFAULT);//pNoisePower->d
		VoC_shr32_ri(ACC1,-1,DEFAULT);//			pNoisePower->d = pNoisePower->d*2;
		VoC_bngt16_rr(Coolsand_BT_OverallNoiseEstwState_L2,REG6,REG4);
...
Coolsand_BT_OverallNoiseEstwState_L2:
		VoC_sw16_p(REG6,REG7,DEFAULT);//save pNoiseFloorDevCnt
		
Coolsand_BT_OverallNoiseEstwState_L3:

	//	if (FrameCnt<50)
	VoC_lw16i(REG4,50);
	VoC_lw32_p(ACC0,REG1,DEFAULT);
	VoC_bngt16_rd(Coolsand_BT_OverallNoiseEstwState_L4,REG4,m_AF_FrameCnt)
		VoC_sw32_p(ACC0,REG0,DEFAULT);// *pNoiseSmoothPower = *pNoisePower;
Coolsand_BT_OverallNoiseEstwState_L4:
	...
	VoC_bnez32_r(Coolsand_BT_OverallNoiseEstwState_L5,ACC0)
		VoC_sw32_p(REG45,REG0,DEFAULT);		
Coolsand_BT_OverallNoiseEstwState_L5:
	...
	VoC_bez16_d(Coolsand_BT_OverallNoiseEstwState_L7,m_AECProcPara_StrongEchoFlag)

	VoC_bne16_rd(Coolsand_BT_OverallNoiseEstwState_End,REG4,r_PF_CL_State)

Coolsand_BT_OverallNoiseEstwState_L7:
		VoC_shr32_ri(REG67,-1,DEFAULT);
		VoC_bgt32_rr(Coolsand_BT_OverallNoiseEstwState_L6,ACC1,REG67);
			VoC_movreg32(RL7,ACC1,DEFAULT);
			VoC_jump(Coolsand_BT_OverallNoiseEstwState_End);		
Coolsand_BT_OverallNoiseEstwState_L6:
		...
		VoC_bgt32_rr(Coolsand_BT_OverallNoiseEstwState_End,ACC0,ACC1);
			VoC_movreg32(RL7,ACC1,DEFAULT);
Coolsand_BT_OverallNoiseEstwState_End:
...
/**************************************************************************************
 * Function:    Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL
 *
 * Description: 
 *
 * Inputs:       
 ...
 * Version 1.0  Created by  Xuml       04/25/2011
 **************************************************************************************/
void Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL(void)
{
	VoC_push16(RA,DEFAULT);
	...
	VoC_jal(Coolsand_BT_EchoPSDEst_MFCOHFFix);
	...
	VoC_bnez32_r(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L0,ACC0)
...
Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L0:
	...
	VoC_bgtz32_r(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L1,RL7)
		VoC_lw16i_short(RL7_LO,1,DEFAULT);
		VoC_lw16i_short(RL7_HI,0,IN_PARALLEL);
Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L1: 
...
// VoC_directive: PARSER_ON	
	...
	VoC_bnez16_d(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L3,m_AECProcPara_StrongEchoFlag)

		VoC_shr16_ri(REG4,-2,DEFAULT);

		VoC_bgt16_rd(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L2,REG4,m_AECProcPara_EchoGainLimit)
			VoC_lw16_d(REG4,m_AECProcPara_EchoGainLimit);
Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L2:
		VoC_shr16_ri(REG4,2,DEFAULT);
		//	// Limit the weight
	//	*pEchoWeight = FixMax(*pEchoWeight, EchoGainLimit);

		VoC_bez16_d(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_End,r_PF_CL_State)
			VoC_lw16i(REG4,127);
		VoC_jump(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_End);
	
Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L3:
		...
		VoC_bne16_rd(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L4,REG2,r_PF_CL_State)

			VoC_lw16_p(REG3,REG5,DEFAULT);//		AmpLimit = pEchoGainLimitAmp[Channel];
			
Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L4:
		...
		VoC_bgt16_rr(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L5,REG4,REG6)
			VoC_movreg16(REG4,REG6,DEFAULT);
			VoC_add16_rr(REG4,REG4,REG7,DEFAULT);//+0.5
Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L5:	
		...
		VoC_bne16_rd(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L6,REG2,r_PF_CL_State)
			VoC_lw16i(REG4,127);
		VoC_jump(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_End);			
Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_L6:		
		VoC_bne16_rd(Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_End,REG3,r_PF_CL_State)
			VoC_lw16i(REG4,127);
Coolsand_BT_ComputeEchoWeight_DeciDirect_MFCOHFCTRL_End:
...
/**************************************************************************************
 * Function:    Coolsand_BT_EchoPSDEst_MFCOHFFix
 *
 * Description: 
 *
 * Inputs:  REG4: 
 ...
 * Version 1.0  Created by  Xuml       04/25/2011
 **************************************************************************************/
void Coolsand_BT_EchoPSDEst_MFCOHFFix(void)
{
	VoC_push16(RA,DEFAULT);
...
//		VoC_movreg16(REG3,ACC1_LO,IN_PARALLEL);//InstantCorrQ
		...
		// Corr Norm 	
	//	VoC_jal(Coolsand_BT_CmplxAppxNorm_int);
	   ...
	   VoC_bgt32_rr(Coolsand_BT_EchoPSDEst_MFCOHFFix_L0,ACC0,ACC1)
		 VoC_movreg32(ACC0,ACC1,DEFAULT);
		 VoC_movreg32(ACC1,ACC0,IN_PARALLEL);//swap
	Coolsand_BT_EchoPSDEst_MFCOHFFix_L0:
...
//		SumCorrNorm2 = SumCorrNorm2+InstantNorm2;
	...
	VoC_bne16_rr(Coolsand_BT_EchoPSDEst_MFCOHFFix_L4,REG3,REG4)	
	VoC_bez32_r(Coolsand_BT_EchoPSDEst_MFCOHFFix_L4,RL6)
		...
		VoC_bnez32_r(Coolsand_BT_EchoPSDEst_MFCOHFFix_L1,ACC0)
			VoC_lw16i_short(ACC0_LO,1,DEFAULT);
			VoC_lw16i_short(ACC0_HI,0,IN_PARALLEL);
Coolsand_BT_EchoPSDEst_MFCOHFFix_L1:
		VoC_movreg32(RL6,ACC0,DEFAULT);
		...
		VoC_bngt32_rr(Coolsand_BT_EchoPSDEst_MFCOHFFix_L2,ACC1,ACC0)
			VoC_lw16i_short(REG2,8,DEFAULT);			
Coolsand_BT_EchoPSDEst_MFCOHFFix_L2:
		...
		VoC_bngt32_rr(Coolsand_BT_EchoPSDEst_MFCOHFFix_L3,RL6,ACC1)
			VoC_shr32_ri(RL6,2,DEFAULT);
			VoC_movreg32(ACC0,RL6,DEFAULT);
Coolsand_BT_EchoPSDEst_MFCOHFFix_L3:


		VoC_bnez32_r(Coolsand_BT_EchoPSDEst_MFCOHFFix_L7,ACC0)
			VoC_lw16i_short(ACC0_LO,1,DEFAULT);
			VoC_lw16i_short(ACC0_HI,0,IN_PARALLEL);
		
			VoC_jump(Coolsand_BT_EchoPSDEst_MFCOHFFix_L7);

Coolsand_BT_EchoPSDEst_MFCOHFFix_L4:
...
//	VoC_pop32(RL6,DEFAULT);
	...
	VoC_bngt32_rr(Coolsand_BT_EchoPSDEst_MFCOHFFix_L5,RL6,ACC1);
	VoC_bnez32_r(Coolsand_BT_EchoPSDEst_MFCOHFFix_L5,RL7);
		VoC_lw16i_short(RL7_HI,0,DEFAULT);
		VoC_lw16i_short(RL7_LO,1,IN_PARALLEL);	
Coolsand_BT_EchoPSDEst_MFCOHFFix_L5:
	

	VoC_bnez32_r(Coolsand_BT_EchoPSDEst_MFCOHFFix_L6,RL6);
	VoC_bez16_d(Coolsand_BT_EchoPSDEst_MFCOHFFix_L6,r_PF_CL_State);
		VoC_lw32z(RL7,DEFAULT);
Coolsand_BT_EchoPSDEst_MFCOHFFix_L6:
...
//	VoC_pop32(ACC0,IN_PARALLEL);//r_PF_EchoPowerEstBuf
	...
	VoC_bez32_r(Coolsand_BT_EchoPSDEst_MFCOHFFix_L7,RL7)
		...
		VoC_bngt32_rr(Coolsand_BT_EchoPSDEst_MFCOHFFix_L7,RL6,ACC1)
			VoC_shr32_ri(RL6,2,DEFAULT);
			VoC_movreg32(ACC0,RL6,DEFAULT);
Coolsand_BT_EchoPSDEst_MFCOHFFix_L7:
	...
	VoC_bnez16_d(Coolsand_BT_EchoPSDEst_MFCOHFFix_End,r_PF_CL_State);
	VoC_bngt32_rr(Coolsand_BT_EchoPSDEst_MFCOHFFix_End,ACC1,RL6);
	VoC_bngt32_rd(Coolsand_BT_EchoPSDEst_MFCOHFFix_End,ACC0,m_AECProcPara_PFPrevEchoEstLimit);

		VoC_sw32_p(ACC1,REG2,DEFAULT);//		*pPrevSpkPower = *pSpkPower;
		VoC_sw32_p(ACC0,REG3,DEFAULT);

Coolsand_BT_EchoPSDEst_MFCOHFFix_End:
...
/**************************************************************************************
 * Function:    Coolsand_BT_ControlLogicDTD
 *
 * Description: 
 *
 * Inputs:  : 
 ...
 **************************************************************************************/
void Coolsand_BT_ControlLogicDTD(void)
{
	VoC_push16(RA,DEFAULT);
	...
	VoC_bnez32_r(Coolsand_BT_ControlLogicDTD_L0,ACC0)

		VoC_lw16i_short(ACC0_LO,1,DEFAULT);
		VoC_lw16i_short(ACC0_HI,0,IN_PARALLEL);

Coolsand_BT_ControlLogicDTD_L0:
	// Instant Err Power
	...
	//	if (pErrPower->d == 0)
	//		pErrPower->d = 1;
	VoC_bnez32_r(Coolsand_BT_ControlLogicDTD_L1,ACC0)

		VoC_lw16i_short(ACC0_LO,1,DEFAULT);
		VoC_lw16i_short(ACC0_HI,0,IN_PARALLEL);

Coolsand_BT_ControlLogicDTD_L1:
	...
	//	if (pEchoPower->d == 0)
	//		pEchoPower->d = 1;
	VoC_bnez32_r(Coolsand_BT_ControlLogicDTD_L2,ACC0)

		VoC_lw16i_short(ACC0_LO,1,DEFAULT);
		VoC_lw16i_short(ACC0_HI,0,IN_PARALLEL);

Coolsand_BT_ControlLogicDTD_L2:
	...
	VoC_jal(Coolsand_BT_Double_FirstOrderIIRSmooth2);
	...
	VoC_bgt32_rr(Coolsand_BT_ControlLogicDTD_L3,ACC0,ACC1)
		VoC_lw16i_short(REG7,0,DEFAULT);	
Coolsand_BT_ControlLogicDTD_L3:
...
//	VoC_NOP();
	...
	VoC_bgtz16_r(Coolsand_BT_ControlLogicDTD_L4,REG3)
		VoC_lw16i_short(REG3,1,DEFAULT);		
Coolsand_BT_ControlLogicDTD_L4:

	VoC_bnez16_r(Coolsand_BT_ControlLogicDTD_L5,REG5)
		VoC_lw16i_short(REG5,1,DEFAULT);		
Coolsand_BT_ControlLogicDTD_L5:
	...
	VoC_bgt32_rr(Coolsand_BT_ControlLogicDTD_L6,ACC0,ACC1)
		VoC_lw16i_short(REG7,0,DEFAULT);	
Coolsand_BT_ControlLogicDTD_L6:
	...
	VoC_bnez16_r(Coolsand_BT_ControlLogicDTD_L7,REG3)
		VoC_lw16i_short(REG3,1,DEFAULT);		
Coolsand_BT_ControlLogicDTD_L7:

	VoC_bnez16_r(Coolsand_BT_ControlLogicDTD_L8,REG5)
		VoC_lw16i_short(REG5,1,DEFAULT);		
Coolsand_BT_ControlLogicDTD_L8:
	...
	VoC_bngt32_rr(Coolsand_BT_ControlLogicDTD_L9,ACC1,RL7)
	VoC_bngt32_rr(Coolsand_BT_ControlLogicDTD_L9,RL6,ACC0)
		VoC_lw16i_short(REG0,1,DEFAULT);
Coolsand_BT_ControlLogicDTD_L9:
 ...
 **************************************************************************************/
void Coolsand_BT_CmplxMul(void)
{
...
/**************************************************************************************
 * Function:    Coolsand_BT_Double_FirstOrderIIRSmooth2
 *
 * Description: 
 *
 * Inputs:  : 
 ...
 * Version 1.0  Created by  Xuml       10/27/2011
 **************************************************************************************/
void Coolsand_BT_Double_FirstOrderIIRSmooth2(void)
{
