...
#include "vppp_speech_asm_map_bt.h"
#include "vppp_speech_sections_bt.h"
...
void Coolsand_BT_read_13bits(void);
...
void Coolsand_BT_decompressed_windows(void);
void Coolsand_BT_If1format2amr(void);
void Coolsand_BT_amr2If1format(void);
void Coolsand_BT_If1_table_selet(void);
/*****************************
 **      HR functions       **
 *****************************/
...
void Coolsand_BT_EsrModelMain(void);
void Coolsand_BT_EsrFilt(void);



//aec
void Coolsand_BT_AnalysisProcessing(void);
void Coolsand_BT_GlobalReset(void);
...
#define GLOBAL_AEC_RAMX_BACKUP_SIZE 1240
#define GLOBAL_AEC_CODE_BACKUP_SIZE 1880
...
void Coolsand_BT_MorphVoiceReset(void);




void Coolsand_BT_Morph(void);
void Coolsand_BT_Aec(void);
