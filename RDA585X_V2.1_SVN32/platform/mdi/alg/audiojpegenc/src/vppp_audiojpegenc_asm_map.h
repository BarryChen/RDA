...
#define COMMON_GLOBAL_Y_SIZE                              		40
...
#define MP3_GLOBAL_Y_BEGIN_ADDR                           		(40 + RAM_Y_BEGIN_ADDR)
#define MP3_LOCAL_X_BEGIN_ADDR                            		(10124 + RAM_X_BEGIN_ADDR)
#define MP3_LOCAL_Y_BEGIN_ADDR                            		(9280 + RAM_Y_BEGIN_ADDR)
#define AMR_GLOBAL_X_BEGIN_ADDR                           		(0 + RAM_X_BEGIN_ADDR)
#define AMR_GLOBAL_Y_BEGIN_ADDR                           		(40 + RAM_Y_BEGIN_ADDR)
#define AMR_LOCAL_X_BEGIN_ADDR                            		(10098 + RAM_X_BEGIN_ADDR)
#define AMR_LOCAL_Y_BEGIN_ADDR                            		(7656 + RAM_Y_BEGIN_ADDR)
#define COMMON_LOCAL_X_BEGIN_ADDR                         		(10124 + RAM_X_BEGIN_ADDR)
#define COMMON_LOCAL_Y_BEGIN_ADDR                         		(9280 + RAM_Y_BEGIN_ADDR)
...
#define GLOBAL_MIC_DIGITAL_GAIN_ADDR            			(38 + COMMON_GLOBAL_Y_BEGIN_ADDR) //1 short
#define Output_reserve1_addr                    			(39 + COMMON_GLOBAL_Y_BEGIN_ADDR) //1 short
...
//RAM_X: size 0x2800, used 0x278c	RAM_Y: size 0x2800, used 0x2440
