...
#if defined(RAM_SIZE_16MBIT)
#define VDS_CACHE_NODE_NUMBER_MAX                  120
#elif defined(RAM_SIZE_32MBIT)
#define VDS_CACHE_NODE_NUMBER_MAX                  400
#elif defined(RAM_SIZE_64MBIT)
#define VDS_CACHE_NODE_NUMBER_MAX                  680
#else
#define VDS_CACHE_NODE_NUMBER_MAX                  120
#endif
