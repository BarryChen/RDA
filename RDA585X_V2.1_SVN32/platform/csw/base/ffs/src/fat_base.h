...
#define FAT_GET_DIR_FSTCLUSLO(buff)   (MAKEFATUINT16((buff)[FLDE_LDIR_FSTCLUSLO_POS],(buff)[FLDE_LDIR_FSTCLUSLO_POS +1]))
...
typedef struct _fat_cache{
    ...
    UINT8   szSecBuf[DEFAULT_SECSIZE];
...
#define FAT_SECT_BUF_ALLOC()   DSM_MAlloc(DEFAULT_SECSIZE)
