...
delete_entry:
    ...
    else  if(FS_ROOT_CLUSTER == bclu)// Operation on the root directory
    {
            ...
            UINT16 *bsec, UINT16 *eoff, WCHAR* pszFileName, BOOL bRename)
{
    ...
    iRet = fat_get_long_entry(sb_info, FS_ROOT_CLUSTER, pszFileName, (FAT_LONG_DIR_ENTRY*)ebuf, &ecount);
    if(_ERR_FAT_SUCCESS != iRet)
    {
