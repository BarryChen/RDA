...
/* row 0  */            KEY_VOL_UP,     KEY_VOL_DOWN,   KEY_NEXT,    	KEY_INVALID,    KEY_INVALID,    KEY_INVALID,    KEY_INVALID,    KEY_INVALID,  \
/* row 1  */            KEY_EQ,    		KEY_INVALID,    	KEY_INVALID,   	KEY_INVALID,    KEY_INVALID,    KEY_INVALID,    KEY_INVALID,    KEY_INVALID,  \
/* row 2  */            KEY_PREV,       KEY_PLAY,       KEY_MODE,    	KEY_INVALID,    KEY_INVALID,    KEY_INVALID,    KEY_INVALID,    KEY_INVALID,  \
}
...
{                                                                         \
    0xbf40, 0x7f80, 0xff00, 0xfd02                                        \
}

#define IRC_MAP                                                       \
{                                                                     \
    {0xff, 0x0a, 0x0c, 0x08}, /* KEY_1   */                           \
    {0xff, 0x1b, 0x18, 0x88}, /* KEY_2   */                           \
    {0xff, 0x1f, 0x5e, 0x48}, /* KEY_3   */                           \
    {0xff, 0x0c, 0x08, 0x28}, /* KEY_4   */                           \
    {0xff, 0x0d, 0x1c, 0xa8}, /* KEY_5   */                           \
    {0xff, 0x0e, 0x5a, 0x68}, /* KEY_6   */                           \
    {0xff, 0x00, 0x42, 0x18}, /* KEY_7   */                           \
    {0xff, 0x0f, 0x52, 0x98}, /* KEY_8   */                           \
    {0xff, 0x19, 0x4a, 0x58}, /* KEY_9   */                           \
    {0xff, 0x07, 0x16, 0x30}, /* KEY_0   */                           \
    {0xff, 0x1a, 0x46, 0x60}, /* KEY_MODE   */                        \
    {0x80, 0x01, 0x44, 0x40}, /* KEY_PLAY   */                        \
    {0xff, 0xff, 0xff, 0xff}, /* KEY_REC   */                         \
    {0xff, 0x02, 0x40, 0xb0}, /* KEY_PREV   */                        \
    {0xff, 0x03, 0x43, 0x70}, /* KEY_NEXT   */                        \
    {0xff, 0x04, 0x07, 0x10}, /* KEY_EQ   */                          \
    {0xff, 0x08, 0x19, 0x20}, /* KEY_LOOP   */                        \
    {0xc0, 0xff, 0xff, 0xff}, /* KEY_MUTE   */                        \
    {0xff, 0xff, 0xff, 0xff}, /* KEY_HALT   */                        \
    {0xff, 0x12, 0x45, 0x00}, /* KEY_POWER   */                       \
    {0x90, 0x06, 0x09, 0x50}, /* KEY_VOL_UP   */                      \
    {0xe0, 0x05, 0x15, 0x90}, /* KEY_VOL_DOWN   */                    \
}
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        /*   POWER or LEVEL LDO.                                    */  \
        .ldoEnableNormal = PMD_LDO_LCD|PMD_LDO_MMC,                                 \
...
#define TGT_AUD_CONFIG_LOUD_SPEAKER_MIXAUDIO       FALSE
...
#define TGT_AUD_CONFIG_BT_SP_MIXAUDIO              FALSE
...
#define TGT_AUD_CONFIG_FM_MIXAUDIO                 FALSE
...
#define TGT_AUD_CONFIG_LINEIN_MIXAUDIO                 FALSE
...
#ifdef TGT_WITH_FM_MODEL_rda5807m
// =============================================================================
#ifndef TGT_FMD_CONFIG
#define TGT_FMD_CONFIG                                                  \
{                                                                   \
...
#define TGT_GPIOI2C_CONFIG                                              \
    {                                                                   \
        .i2c_gpio_Bps       = GPIO_I2C_BPS_160K ,                        \
