...
// GPIO(21) // UART1_RTS
#define TGT_HAL_GPIO_21_USED AS_GPIO
// GPIO(22) // M_CS2
...
{                                                                       \
    ...
    .uartKeyinoutSel    = {                                             \
         ...
         .keyout1GpioEn = 1, /* GPIO_17 */                              \
         .keyout2GpioEn = 1, /* GPIO_11 */                              \
         .keyout3GpioEn = 1, /* GPIO_7 */                               \
         .keyout4GpioEn = 1, /* GPIO_8 */                               \
     },                                                                 \
...
#define TGT_AUD_CONFIG_EAR_PIECE_INPUT_PATH        AUD_MIC_LOUD_SPEAKER
...
#define TGT_AUD_CONFIG_LOUD_SPEAKER_OUTPUT_PATH    AUD_SPK_RECEIVER
