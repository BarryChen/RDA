...
#define PLAYING_WAIT_A          0x0B//等回到A点
#define PLAYING_WAIT_B          0x0D//等DSP把B点定好(basal 内用)
#define PLAYING_ERROR           0x0C
#define PLAYING_REACH_HEAD      0x0E//快进到头
...
typedef struct
{
	...
	UINT32  file_entry;       //cluster no,保存当前目录所在的族号，或者播放列表的所在族,file_inode
