...
#define SEATCHLIST_SWTICH_TIME                (1*1000)
...
{
	timer_started = 1;
	press_key_timer = COS_SetTimer(SEATCHLIST_SWTICH_TIME, _PressKeyCounter_Timeout, NULL, COS_TIMER_MODE_SINGLE);
}
