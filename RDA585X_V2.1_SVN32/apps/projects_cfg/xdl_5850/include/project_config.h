...
#define APP_SUPPORT_DELAY_VOLUME        1
...
#define XDL_APP_SUPPORT_LOWBAT_DETECT  1//warkey add
#define XDL_APP_SUPPORT_TONE_TIP		1//xundon add
#define XDL_APP_BT_MSG_PRINTF              1//howe add
/**********************************************
* suppport lanaguages
**********************************************/
